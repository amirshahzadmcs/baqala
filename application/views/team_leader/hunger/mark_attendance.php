                    ...
                    <div class="col-sm-6">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url('team_leader/logistic-management/hunger/team-list'); ?>">Mark Attendace</a></li>
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="row px-2 py-4 mx-2">
                                    <div class="w-50">
                                        <h4 class="header-title float-start">Available To Attendance</h4>
                                    </div>
