...
<html lang="en">
    <head>
        ...
        <title>Logistic Partner | Login</title>
			...
			<div class="login100-form">
				...
				<div class="form-container" id="signup-form">
					<div class="message-toast">
						...
						<?php } } $this->logistic->removeInfo();?>
					</div>
					<form class="validate-form" method="POST" action="<?= base_url('logistic-partner/login-submit');?>">
						<div class="pt-5">
							<h1 class="main-heading">Welcome Back Logistic Partner</h1>
					...
					<p class="mt-2 text-center">Don't remember your password? <a href="<?= base_url('logistic-partner');?>" class="theme-color">Forgot Password</a></p>
				</div>
			</div>
			<div class="login100-more" style="background-image: url('images/logistic-partner.avif');"></div>
        </div>
        <!-- /container -->
