								...
								<div class="tab-pane active" id="home1" role="tabpanel">
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<input type="text" class="form-control" id="name" name="name" maxlength="120" onBlur="checkDuplicateName()" required />
										...
										<table class="table table-striped table-bordered table-hover">
											...
											<tbody>
												<tr>
													<td>Sunday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[sunday]" id="sunday" />
												...
												<tr>
													<td>Monday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[monday]" id="monday" />
												...
												<tr>
													<td>Tuesday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[tuesday]" id="tuesday" />
												...
												<tr>
													<td>Wednesday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[wednesday]" id="wednesday" />
												...
												<tr>
													<td>Thursday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[thursday]" id="thursday" />
												...
												<tr>
													<td>Friday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[friday]" id="friday" />
												...
												<tr>
													<td>Saturday</td>
													<td class="text-left">
														<input type="checkbox" switch="bool" name="week_days[saturday]" id="saturday" />
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											...
											<input type="time" class="form-control" id="ending_in" name="ending_in" required />
										</div>
										<div class="col-md-6 col-sm-12 mb-2 form-group">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											...
											<input type="time" class="form-control" id="ending_out" name="ending_out" required />
										</div>
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											<label for="late_time">Late Time: <span class="required-field">*</span></label>
											<div class="input-group" id="datepicker1">
												<span class="input-group-text"><i class="mdi mdi-clock"></i></span>
												<input type="number" class="form-control" id="late_time" name="late_time" required />
												<span class="input-group-text">Minutes</span>
											</div>
										</div>
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											<label for="start_late_time_from_on_duty" class="d-block">Start late time from on duty: <span class="required-field">*</span></label>
											<input class="checkbox" type="checkbox" id="start_late_time_from_on_duty" name="start_late_time_from_on_duty" style="margin-right: 10px;height: 36px;width: 36px;">
