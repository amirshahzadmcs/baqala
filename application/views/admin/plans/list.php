		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'palns', 'delete')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'plans', 'add')): ?>
						<a class="btn btn-custom-success btn-sm pull-right" title="Add" href="<?php echo base_url('admin/plan/add') ?>"><i class="fa fa-plus"></i> Add</a>
					<?php endif; ?>
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open('admin/plan/delete', array("id" => "delete_form")); ?>
							...
							<tbody>
								...
								foreach ($regions as $region) { ?>
									<tr>
										...
										<td><?php echo $region->sim_type; ?></td>
										<td><?php echo $region->plan_name; ?></td>
										...
										<td><?= check_action_permission(get_user_role(), 'plans', 'add') ? '<a class="btn btn-outline-secondary btn-custom-light btn-sm edit" data-toggle="tooltip" title="Edit" href="' . base_url() . 'admin/plan/add?id=' . $region->id . '"><i class="mdi mdi-pencil font-size-18"></i></a>' : ''; ?></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
