...
class Banners extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('admin/app_setting/slider/list',$data);
	}

	public function add(){
		$data['categories'] = $this->Category_model->get_category();
		$this->load->view('admin/app_setting/slider/form',$data);
	}
	...
	public function edit(){
		...
		$data['categories'] = $this->Category_model->get_category();
		$this->load->view('admin/app_setting/slider/edit',$data);
	}
	...
	public function save_banner(){
		...
		redirect('admin/app/banner/list');
	}
