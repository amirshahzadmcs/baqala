...
<style>
	...
	.password-modal input, .password-modal textarea, .password-modal select, .password-modal select.select2{
		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<?php }?>
					<a type="button" class="btn btn-sm btn-custom-danger pull-right ms-2" title="Change Password" data-bs-toggle="modal" data-bs-target=".password-modal"> Change Password</a>
								...
								<div class="tab-pane active" id="profileTab" role="tabpanel">
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="hiring_type" id="hiring_type" class="form-control" required data-placeholder="Choose Hiring Type...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select class="form-control" name="applicant_country" id="applicant_country" required>
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<input type="text" class="form-control rtl-input" id="employee_arabic_name" name="employee_arabic_name" maxlength="150" value="<?php echo $emp_detail->employee_arabic_name; ?>" />
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="gender" id="gender" class="form-control" required data-placeholder="Choose Gender...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="marital_status" id="marital_status" class="form-control" required data-placeholder="Choose Marital Status...">
												<option value="">Select</option>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<input type="email" class="form-control" id="email" name="email" value="<?php echo $emp_detail->email; ?>" required />
											<small class="hint">Enter Email</small>
										</div>
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											<label for="status">Status <span class="required-field">*</span></label>
											<select name="status" id="emp_status" class="form-control" required>
												<option value="">Select</option>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="employee_mode" id="employee_mode" class="form-control" required data-placeholder="Employee Mode...">
										...
										<div class="row access-checked <?php echo ($emp_detail->allow_access == 'on') ? '' : 'd-none';?>">
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select name="display_language" id="display_language" class="form-control">
											...
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select name="employee_role" id="employee_role" class="form-control" data-placeholder="Employee Role...">
											...
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select name="branches" id="branches" class="form-control" data-placeholder="Employee Accessible Branches...">
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="iqama_issue_country" id="iqama_issue_country" class="form-control" data-placeholder="Choose Country..." required>
												<option value="">Select</option>
												<?php foreach($nationalities as $nation) { ?>
										...
										<div id="saudi-dl-container" class="row">
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select name="dl_issuing_authority" id="dl_issuing_authority" class="form-control">
													<option value="">Select Type</option>
											...
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select name="dl_type" id="dl_type" class="form-control">
													<option value="">Select Type</option>
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="designation" id="designation" class="form-control" required data-placeholder="Choose Designation...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="department" id="department" class="form-control" required data-placeholder="Choose Department...">
												<option value="">Select Designation</option>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="branch" id="branch" class="form-control" required data-placeholder="Choose Branch...">
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="attendance_shift" id="attendance_shift" class="form-control" data-placeholder="Choose Attendance Shift...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="leave_policy" id="leave_policy" class="form-control" data-placeholder="Choose Leave Policy...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="holiday_list" id="holiday_list" class="form-control" data-placeholder="Choose Holiday List...">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="attendance_restriction" id="attendance_restriction" class="form-control" data-placeholder="Choose Attendance Restriction...">
									...
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<select name="passport_issue_country" id="passport_issue_country" class="form-control" data-placeholder="Choose Passport Issue Country...">
												<option value="">Select Country</option>
												<?php foreach($nationalities as $nation) { ?>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											...
											<input type="text" class="form-control" id="passport_issue_city" name="passport_issue_city" value="<?php echo $emp_detail->passport_issue_city; ?>" maxlength="100" />
											<small class="hint">Enter passport issue city</small>
										</div>
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											<label for="passport_no">Passport Number</label>
											<input type="text" class="form-control" id="passport_no" name="passport_no" minlength="8" maxlength="<?= PASSPORT_LENGTH;?>" value="<?php echo $emp_detail->passport_no; ?>" />
											<small class="hint">Enter Passport Number</small>
										</div>
										<div class="col-md-4 col-sm-12 mb-2 form-group">
											<label for="passport_exp">Passport Expiry Date</label>
											<input type="date" class="form-control" id="passport_exp" name="passport_exp" min="<?php echo date("Y-m-d"); ?>" value="<?php echo $emp_detail->passport_exp; ?>" />
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													...
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Documents"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Profile Picture"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Saudi DL"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Iqama"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="DL Documents"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Offer Letter"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Medical Certificate"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
														<p>Medical Certificate Not Uploaded</p>
													</div>
												<?php }} ?>
											</div>
										</div>
										...
										<div class="col-md-4 col-sm-12 mb-2 form-group mb-4">
											...
											<div class="col-md-12">
												...
												<div class="float-start text-center image-container mt-2 me-2" id="img_<?php echo $cv_doc['id'];?>">
													<img src="<?php echo ($file_extension == 'doc' || $file_extension == 'docx' || $file_extension == 'pdf') ? base_url('images/attached-file.png') : base_url($cv_doc['document']); ?>" class="cv-documents" />
													<div class="overlay"></div>
													<div class="edit"><a type="button" onclick="viewCertificate(this)" class="btn btn-primary btn-sm" target="_blank" title="View" data-doc="<?php echo base_url($cv_doc['document']);?>" data-type="Visa Copy"><i class="fa fa-eye"></i></a></div>
												</div>
												<?php }}}else{ ?>
													<div class="float-start text-center cv-documents mt-2 me-2">
...
<div class="modal fade password-modal" role="dialog" aria-labelledby="ModalPasswordLabel" aria-hidden="true">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title mt-0" id="summaryModalPasswordLabel">Change Password</h6>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<form id="password_form" action="<?php echo base_url('admin/hr/master/employee/update-password'); ?>" method="POST">
					...
					<div class="row">
						...
						<div class="form-group col-lg-12 col-md-12 col-12 mb-3">
							...
							<input type="password" class="form-control" id="confirm_password" name="confirm_password" minlength="6" maxlength="50" required />
						</div>
						<div class="form-group col-lg-12 col-md-12 col-12 mb-3">
							<button type="submit" class="btn btn-custom-success float-end">Update Password</button>
						</div>
					</div>
				</form>
			</div>
