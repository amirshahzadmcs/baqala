        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Inventory In Stock List</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="float-end d-sm-block">
					<a href="<?php echo base_url();?>admin/warehouse/inventory/list" class="btn btn-custom-white btn-sm waves-effect waves-light me-1"><i class="fa fa-reply"></i> Back</a>
                    ...
                    <?=($this->uri->segment(4) == 'instock' ? '<a class="btn btn-custom btn-sm me-1" href="'.site_url().'admin/export/instockexcel" target="_blank"><i class="fa fa-file-excel-o"></i> Export to Excel</a>' : '<a class="btn btn-custom btn-sm me-1" href="'.site_url().'admin/export/outstockexcel" target="_blank"><i class="fa fa-file-excel-o"></i> Export to Excel</a>');?>
                </div>
...
<div class="container-fluid">
    <div class="page-content-wrapper">
        <div class="row">
			...
			<?php if($this->uri->segment(4) == 'outstock'){?>
                    ...
                    <div class="card <?=($this->uri->segment(4) == 'outstock' ? 'active' : '');?>">
                        <div class="card-body">
                            <div class="text-center">
                                <p class="text-primary fw-bold">TOTAL OUT OF STOCK</p>
			...
			<div class="col-xl-3 col-md-4">
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<p class="text-primary fw-bold">FILTER OUT OF STOCK</p>
							<h5 class="font-size-22"><?php echo $total_stock; ?></h5>
						</div>
					</div>
				</div>
            </div>
			<div class="col-xl-3 col-md-4">
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<p class="text-primary fw-bold">OUT OF STOCK VALUE:</p>
			...
			<div class="col-xl-3 col-md-4">
				<a href="<?php echo base_url();?>admin/warehouse/inventory/instock?keyword=instock" target="_blank">
                    <div class="card <?=($this->uri->segment(4) == 'list' ? 'active' : '');?>">
                        <div class="card-body">
                            <div class="text-center">
                                <p class="text-primary fw-bold">TOTAL IN STOCK</p>
                                <h5 class="font-size-22"><?php echo $total_inventory; ?></h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-md-4">
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<p class="text-primary fw-bold">FILTER IN STOCK</p>
							<h5 class="font-size-22"><?php echo $total_stock; ?></h5>
						</div>
					</div>
				</div>
			...
			<div class="col-xl-3 col-md-4">
				<div class="card">
					<div class="card-body">
						<div class="text-center">
							<p class="text-primary fw-bold">IN STOCK VALUE:</p>
							<h5 class="font-size-22"><?php echo $total_value->total_price; ?></h5>
						</div>
					</div>
				</div>
    ...
    <div class="modal-dialog modal-dialog-aside">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('admin/warehouse/inventory/'.$this->input->get('keyword')); ?>" method="get" id="filter_form">
					<div class="row">
						<div class="col-12">
							<div class="form-group mb-3">
								<input type="hidden" value="<?php echo $this->input->get('keyword');?>" name="keyword" />
						...
						<div class="col-md-12" style="padding-top: 15px;">
							<a href="<?php echo base_url(); ?>admin/warehouse/inventory/<?php echo $this->input->get('keyword');?>?keyword=<?php echo $this->input->get('keyword');?>" class="btn btn-danger btn-md">Clear Filter</a>
...
<script>
	$(document).ready(function () {
		$("#example").dataTable({
			...
			ajax: {
				url: "<?php echo base_url()?>admin/inventory/get_filtered_list?keyword=<?php echo $this->input->get('keyword');?>&category_id=<?php echo $this->input->get('category_id');?>&brand=<?php echo $this->input->get('brand')?>&from=<?php echo $this->input->get('from')?>&to=<?php echo $this->input->get('to')?>&status=<?php echo $this->input->get('status')?>",
				type: "POST",
