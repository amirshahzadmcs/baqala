	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
					...
					<div>
						<div class="animated flipInY col-lg-3 col-md-3 col-sm-4 col-xs-12">               
							<div class="tile-stats bg-green" style="padding: 10px;">
								...
								<div class="count">SAR <?php echo round($result->wallet,2);?></div>
								</a>
							</div>     
						</div>
						<div class="animated flipInY col-lg-3 col-md-3 col-sm-4 col-xs-12">               
							<div class="tile-stats bg-blue" style="padding: 10px;">
								...
								<div class="count">SAR <?php echo round($total_credit->amount_reveived == 0 ? '0':$total_credit->amount_reveived,2);?></div>
								</a>
							</div>     
						</div>  
						...
						<div class="animated flipInY col-lg-3 col-md-3 col-sm-4 col-xs-12">               
							<div class="tile-stats bg-purple" style="padding: 10px;"> 
								<a href="javascript:void(0)" target="_blank" class="white">
								<h4>Debit Balance:</h4>
								<div class="count">SAR <?php echo round($total_debit->amount_paid == 0 ? '0':$total_debit->amount_paid,2);?></div>
								</a>
							</div>     
						</div>
				...
				<form action="<?php echo base_url(); ?>admin/user/wallet_report" method="get" id="filter_form">
					<div class="col-md-12" style="border: 1px solid #eaeaea;padding: 13px;margin: 10px 0px;">
						...
						<div class="col-md-3" style="margin-top: 23px;">
							...
							<a href="<?php echo base_url(); ?>admin/user/wallet_report?id=<?php echo $result->id;?>" class="btn btn-warning">Reset Filter</a>
						</div>
					</div>
				</form>
