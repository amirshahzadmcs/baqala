...
<?php echo form_open("admin/hr-module/request/disputes/save", array("id" => "addDisputeForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#addDisputeForm').on('submit', function (e) {
			e.preventDefault();
