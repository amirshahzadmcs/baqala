			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Pay Head List</li>
					</ol>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'pay_heads', 'delete_pay_head')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'pay_heads', 'add_pay_head')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/pay_head/add') ?>"><i class="fa fa-plus"></i> Add Pay Head</a>
					<?php endif; ?>
				</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			"fixedHeader": true,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/HrMaster/get_pay_head_list",
				type: "POST"
			},
			"columnDefs": [{
				"targets": [0, 1, 2, 3, 4, 5],
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected pay head data?") == true) {
				changeActionAndSubmit('admin/hr/master/pay_head/delete');
			} else {
