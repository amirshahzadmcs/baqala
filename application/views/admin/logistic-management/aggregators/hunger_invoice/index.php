		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Hunger Sales Invoice</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/invoices/hunger-sales-invoice/list'); ?>">Hunger Sales Invoice</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'sales_invoice', 'print_sales_data') || check_action_permission(get_user_role(), 'sales_invoice', 'export_sales_data')): ?>
					...
					<?php endif; ?>
					<?php if (check_action_permission(get_user_role(), 'sales_invoice', 'import_file')): ?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="bulkImportModalLabel">Hunger Sales Invoice</h5>
				...
				<form id="delivery_bulk_form" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="row px-3">
						...
						<div class="col-md-12">
							...
							<p style="text-align: center;"><a type="button" href="<?php echo base_url('admin_assets/samples/Hunger-Sales-Invoice.xlsx'); ?>" class="btn bt btn-link text-success" target="_blank" download>Download sample file</a></p>
						</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="exportForm" action="<?php echo base_url('admin/logistic-management/invoices/hunger-sales/print-monthly-sales'); ?>" method="POST">
					...
					<div class="row">
						<?php if (check_action_permission(get_user_role(), 'sales_invoice', 'print_sales_data')): ?>
							<div class="col-md-12">
								<div class="form-check mb-3">
						...
						<?php endif; ?>
						<?php if (check_action_permission(get_user_role(), 'sales_invoice', 'export_sales_data')): ?>
							<div class="col-md-12">
								<div class="form-check mb-3">
...
<script>
	...
	$(document).ready(function() {
		...
		function initializeDataTable() {
			...
			table = $('#summaryTable').DataTable({
				...
				"processing": true,
				"ajax": {
					url: "<?php echo base_url(); ?>admin/logistic-management/invoices/hunger-sales-invoice/ajax-list",
					type: "POST",
					data: function(d) {
	...
	$(document).ready(function() {
		$("body").on("submit", "#delivery_bulk_form", function(e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo base_url('admin/logistic-management/invoices/hunger-sales-invoice/import-file') ?>",
				data: data,
				//dataType: 'json',
				contentType: false,
				cache: false,
	...
	function getColumnForm() {
		$.ajax({
			...
			method: 'GET',
			data: {
				request_type: 'hunger_sales_invoice'
			},
			success: function(response) {
	...
	$(document).ready(function() {
		...
		$('#exportForm').on('submit', function(e) {
			...
			let exportUrl = (fileFormat === 'file_format_xlsx') ?
				'admin/logistic-management/invoices/hunger-sales-invoice/export-monthly-sales' :
				'admin/logistic-management/invoices/hunger-sales-invoice/print-monthly-sales';
