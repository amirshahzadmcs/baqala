				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'main_id', 'emp_id', 'emp_no', 'full_name', 'partner_id', 'partner_name', 'billing_cycle', 'courier_id', 'courier_name', 'transaction_type', 'business_id', 'note', 'detail_amount', 'total_payable_amount', 'ticket_id', 'violation_id', 'violation_type', 'punishment_methods', 'created_at', 'updated_at'
                        ];
                    ?>
	...
	$(document).ready(function() {
        ...
        $('#savePreferences').on('click', function(e) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    module_name: 'keeta_monthly_summary',
