...
class Vehicle_allotment_model extends CI_Model{
	...
	function make_query() {
		$sql = "SELECT la.* FROM request_approval la WHERE la.approval_types = 'VehicleAllotmentRequest'";
		return $sql;
	}
	...
	public function get_all_employees() {
		// Check if any VehicleAllotmentRequest has `is_applicable_to_all = yes`
