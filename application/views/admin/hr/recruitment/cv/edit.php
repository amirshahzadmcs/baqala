...
<div class="container-fluid">
	<div class="page-content-wrapper">
		<?php echo form_open("admin/hr/recruitment/cv/update", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<input type="hidden" id="id" name="id" value="<?php echo $cv_detail->id; ?>" />
						...
						<div class="row size-inner-section px-2 py-4">
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="date" class="form-control" id="passport_exp" name="passport_exp" value="<?php echo $cv_detail->passport_exp; ?>" required />
							...
							<div id="dl-container" class="row d-none">
								...
								<div class="col-md-4 col-sm-12 mb-3 form-group">
									...
									<input type="date" class="form-control" id="dl_expiry" name="dl_expiry" value="<?= $cv_detail->dl_expiry; ?>" />
							...
							<div id="saudi-dl-container" class="row d-none">
								...
								<div class="col-md-4 col-sm-12 mb-3 form-group">
									...
									<input type="date" class="form-control" id="current_dl_expiry" name="current_dl_expiry" value="<?= $cv_detail->current_dl_expiry; ?>" />
						...
						<div class="row size-inner-section px-2 py-4 cv-status-depend">
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group <?php echo ($cv_detail->hiring_type == 'Rider') ? '' : 'd-none';?>" id="riderPackage">
								...
								<select name="rider_package_id" id="rider_package_id" class="form-select select2" >
						...
						<div class="row size-inner-section px-2 py-4 deployment-status-depend">
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<select name="border_entry_no" id="border_entry_no" class="form-select select2">
									...
									<?php if($borders_list->num_rows() > 0){ foreach ($borders_list->result() as $bor_nos) { ?>
										<option value="<?php echo $bor_nos->border_nos; ?>" data-sponsorid="<?php echo $bor_nos->unified_no; ?>" data-sponsorname="<?php echo $bor_nos->sponsor_name; ?>" <?php echo ($bor_nos->border_nos == $cv_detail->border_entry_no) ? ' selected ' : '' ?>><?php echo $bor_nos->border_nos; ?></option>
									<?php }}else{ ?>
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="text" class="form-control" id="sponsor_id" name="sponsor_id" maxlength="30" value="<?php echo $cv_detail->sponsor_id; ?>" readonly />
								<small class="hint">Enter Sponsor ID</small>
							</div>
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								<label for="sponsor_name">Sponsor Name<span class="text-danger">*</span></label>
								<input type="text" class="form-control" id="sponsor_name" name="sponsor_name" maxlength="120" value="<?php echo $cv_detail->sponsor_name; ?>" readonly />
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								<label for="visa_entry_date">Visa Entry Date<span class="text-danger">*</span></label>
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="date" class="form-control" id="visa_expiry" name="visa_expiry" value="<?php echo $cv_detail->visa_expiry; ?>" />
	    ...
	    $.ajax({
			...
			success: function(data) {
				...
				if (Object.keys(data).length > 0) {
				    var selectedPosition = <?php echo $cv_detail->applied_for; ?>;
					$.each(data, function(index, item) {
					    var isSelected = (item.id == selectedPosition) ? " selected " : "";
						html += '<option value="' + item.id + '" data-id="' + item.id + '" "' + isSelected + '">' + item.name + '</option>';
					});
				} else {
