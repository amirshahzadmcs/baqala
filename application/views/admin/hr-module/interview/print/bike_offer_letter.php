...
<head>
	...
	<title>Job Offer Letter - Bike Rider</title>
	<style>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="font-size: 10px; width: 100%;">
		<tr>
			<td colspan="3">
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size: 10px;">
						...
						<td valign="middle" height="20px" style="text-align: left;">
							<table width="100%" border="1" cellspacing="0" cellpadding="2" style="font-size: 10px;">
								<tr>
									...
									<td valign="middle" height="20px" width="50%" style="text-align: left;">SAR 2,200.00</td>
								</tr>
							</table>
						</td>
						<td valign="middle" height="20px" style="text-align: left;">
							<table width="100%" border="1" cellspacing="0" cellpadding="2" style="font-size: 10px;">
								<tr>
									<td valign="middle" height="20px" width="50%" style="text-align: right;"> 2,200.00 ر س  </td>
                    ...
                    <tr>
						<td valign="middle" height="20px" style="text-align: left;">
							<table width="100%" border="1" cellspacing="0" cellpadding="2" style="font-size: 10px;">
								<tr>
									<td valign="middle" height="20px" width="50%" style="text-align: left;">Bike</td>
									<td valign="middle" height="20px" width="50%" style="text-align: left;">Provided by Company</td>
								</tr>
							</table>
						</td>
				...
				<table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size: 10px;">
                    <tr>
                        <td valign="middle" style="text-align: left;"><br><br> Target & Incentive</td>
                        <td valign="middle" style="text-align: left;">
                            &nbsp;&nbsp;• 0 to 449 SAR 4 each order<br>
                            &nbsp;&nbsp;• 0 to 450 SAR 4.9 each order<br>
                            &nbsp;&nbsp;• 451 onwards SAR 7 each order
                        </td>
                        <td valign="middle" style="text-align: right;"><br><br>  الهدف والحافز  </td>
                    </tr>
                </table>
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size: 10px;">
                    <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
        <tr>
            <td valign="middle" style="width: 100%;"><img src="<?php echo base_url('admin_assets/images/header/offer-footer.png');?>"></td>
        </tr>
    </table>
</body>
