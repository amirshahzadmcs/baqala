...
<head>
	...
	<title>Maha Al Fala Trading Company - Cash Collection Statement</title>
	<style>
...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="0" style="width: 100%;">
		...
		<tr>
			<td valign="top" style="width:27%;text-align: left;font-size: 16px;line-height:15px;">
				<strong>CASH COLLECTION STATEMENT</strong><br><strong> تقرير تحصيل النقدية </strong>
			</td>
	...
	<table border="0" cellspacing="0" cellpadding="3" style="width: 100%;font-size: 9px;">
		<tr>
			<td colspan="4" valign="center" style="text-align: left;border-bottom:1px solid #000;"><strong>CASH COLLECTION DETAILS / تفاصيل تحصيل النقدية</strong></td>
		...
		<tr style="background-color:#f1f1f1;">
			...
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:7%;line-height:10px;">Date<br>رقم الموظف</td>
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:7%;line-height:10px;">Emp. ID<br>اسم الموظف</td>
			...
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:8%;line-height:10px;">Aggregator ID<br>معرف المجمع</td>
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:8%;line-height:10px;">COD Amnt.<br>رقم الوثيقة</td>
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:8%;line-height:10px;">Driver Debit<br>خصم السائق</td>
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:8%;line-height:10px;">Driver Credit<br>إئتمان السائق</td>
			<td align="center" style="border-top:1px solid #000;border-bottom:1px solid #000;border-right:1px solid #000;width:8%;line-height:10px;">Collection<br>تحصيل</td>
        ...
        foreach ($cash_reports as $key => $value) { 
			$due = is_numeric($value['due_amount']) ? (float)$value['due_amount'] : 0;
        ...
        <tr>
			...
			$transaction_date = ($value['transaction_date'] !== '' && $value['transaction_date'] !== '0000-00-00' && $value['transaction_date'] !== NULL) ? $transaction_date : 'NA';
			?>
			<td align="center" style="border-bottom:1px solid #000;border-right:1px solid #000;"><?php echo $transaction_date;?></td>
	...
	<?php }else{ ?>
            <td colspan="10" align="center" style="border-bottom:1px solid #ddd;">No data found</td>
        <?php } ?>
	</table>
