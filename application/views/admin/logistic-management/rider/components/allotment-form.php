<div class="modal-header">
	<h5 class="modal-title mt-0" id="addRiderModalLabel">Allot Aggregator ID</h5>
...
<div class="modal-body">
	...
	<div class="size-inner-section px-1 py-1 mx-1">
		...
		<div class="size-inner-section px-1 py-1 mx-1">
			<div class="card-header">Fill Allotment Information</div>
			<?php echo form_open("admin/logistic-management/rider/save-allot", array("id" => "riderProfileForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
				...
				<div class="row p-2">
					...
					<div class="col-md-12 col-sm-12 mb-2 form-group">
						...
						<textarea class="form-control" name="reason" id="message" placeholder="Write message here..."></textarea>
					</div>
...
<div class="modal-footer" id="searchModalFooter">
	...
	<button type="submit" form="riderProfileForm" class="btn btn-custom-success">Allot</button>
</div>
...
<script>
	$(document).ready(function() {
		...
		$('#riderProfileForm').submit(function(e) {
			...
			$.ajax({
				url: '<?php echo base_url('admin/logistic-management/rider/save-allot');?>',
				type: 'POST',
				data: formData,
				dataType: 'json',
				processData: false,
