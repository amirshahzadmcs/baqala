		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Keeta <?= ((isset($summaryData['summary_month'])) ? date('F Y', strtotime($summaryData['summary_month'])) : ''); ?> Sales Data</h4>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<a class="btn btn-sm btn-custom-white pull-right" title="Back" href="<?php echo base_url('admin/logistic-management/invoices/keeta-sales/list'); ?>"><i class="fa fa-reply"></i> Back</a>
...
$(document).ready(function() {
    ...
    function loadFilteredData(page = 1) {
        ...
        // AJAX Request
        $.ajax({
            url: "<?= base_url('admin/logistic-management/invoices/keeta-sales/detail/' . $summaryData['id']) ?>",
            type: 'GET',
            ...
            success: function(response) {
				...
				if (availableColumns.length) {
					...
					availableColumns.forEach(column => {
						const cleanedHeader = column.replace('mkss.', '').replace('me.', '');
...
function getColumnForm() {
	$.ajax({
		...
		method: 'GET',
		data: { request_type: 'keeta_sales_data' },
		success: function(response) {
