...
<head>
	...
	<title>Baqala Station - Good Received Voucher</title>
	<style>
	...
	<tr>
			<td colspan="3">
				<table width="100%" border="1" cellspacing="0" cellpadding="5">
					<tr>
						...
						<td valign="top" bgcolor="#CCCCCC" style="width: 24%;"><strong>PRODUCT NAME/ DESCRIPTION</strong></td>
						<td valign="top" bgcolor="#CCCCCC" style="width: 5%;"><strong>QTY</strong></td>
						<td valign="top" bgcolor="#CCCCCC" style="width: 7%;"><strong>UNIT PRICE</strong></td>
						...
						<td valign="top" bgcolor="#CCCCCC" style="width: 9%;"><strong>SELLABLE QTY</strong></td>
						<td valign="top" bgcolor="#CCCCCC" style="width: 10.5%;"><strong>UNSELLABLE QTY</strong></td>
					</tr>
						...
						<tr>
							...
							<td style="vertical-align: top; width: 37%;">
								<table border="1" cellspacing="0" cellpadding="5" style="font-size: 10px; width: 100%;border-top:none;">
									<tr>
										<td colspan="2" style="text-align: right;width:71.6%;">SUBTOTAL</td>
										<td style="text-align:right;width:28.4%;" class="amount subtotal"><?php echo $order->sub_total;?></td>
									</tr>
									<tr>
		...
		<tr>
			<td colspan="3">
				<table width="100%" border="1" cellspacing="0" cellpadding="5">
					<tr>
						<td valign="top" bgcolor="#eee"><strong>Store Incharge</strong></td>
