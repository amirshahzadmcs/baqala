            ...
            <div class="col-sm-6">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/hunger/team-list'); ?>">Shift</a></li>
            ...
            <div class="col-sm-6 message_place">
                <div class="float-end d-sm-block">
                    <!-- <button type="button" class="btn btn-custom-danger btn-sm pull-right" onclick="deleteAction()" title="Delete"><i class="fa fa-trash me-1"></i> Delete</button> -->
                     <?php if(check_action_permission(get_user_role(), 'shift_master','create_shift')):?>
                    <button type="button" class="btn btn-custom-success btn-sm pull-right" data-bs-toggle="modal" data-bs-target="#shiftModal" title="Create"><i class="fa fa-plus me-1"></i>Create Shift</button>
                    <?php endif;?>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group mb-2">
                                        <label>Search by Shift Name</label>
                ...
                <div class="card">
                    <div class="card-body">
                        <form id="myform" name="myform" method="post" action="">
                            <table id="masterShiftTable" class="table table-striped table-bordered jambo_table bulk_action" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>S.No.</th>
                                        <th>Name</th>
...
<!-- Create Team -->
<div class="modal fade fixed-left shiftModal" id="shiftModal" data-bs-backdrop="static" aria-labelledby="#replacementModalModalLabel2" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-aside">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="shiftModalLabel">Create Shift</h5>
            ...
            <div class="modal-body">
                ...
                <div id="searchResult2" class="mt-4">
                    <div class="size-inner-section px-1 py-1 mx-1">
                        <div class="card-header">Fill Shift Detail</div>
                        <?php echo form_open("admin/logistic-management/hunger/create-shift", array("id" => "createShiftForm", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
                        <input type="hidden" name="shift_id" id="shiftId" value="">
                        <div class="row p-2">
                            <div class="col-md-6 col-sm-12 mb-2 form-group">
                                <label for="shiftName">EN Name:<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="shiftName" name="name" required />
                            </div>

                            <div class="col-md-6 col-sm-12 mb-2 form-group">
                                <label for="shiftArName">Arabic Name:<span class="text-danger">*</span></label>
                                <input type="text" class="form-control rtl-input" id="shiftArName" name="ar_name" />
                            </div>
                        </div>
                        <?php echo form_close(); ?>
                    </div>
            ...
            <div class="modal-footer" id="searchModalFooter2">
                ...
                <button type="submit" form="createShiftForm" class="btn btn-custom-success" id="submitBtn">Submit</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
