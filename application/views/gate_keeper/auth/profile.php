				...
				<div class="card-body">
					<div class="row profile-sidebar">
						...
						<div class="col-md-2 profile-userpic text-center">
							<img src="<?= base_url('store_assets/images/users/avatar.png'); ?>" class="img-responsive" alt="user" style="width: 100px;">
						</div>
						<!-- END SIDEBAR USERPIC -->
						<!-- SIDEBAR USER TITLE -->
						<div class="col-md-10 profile-usertitle">
							<div class="profile-usertitle-job">
								<h6 class="text-left"><?= $result->emp_no; ?></h6>
							</div>
							<div class="profile-usertitle-name">
								<h5 class="text-left mt-3"><?= ($result->full_name !== '') ? $result->full_name : 'N/A'; ?>/ <?php echo $result->employee_arabic_name ?></h5>
							</div>

							<div class="profile-usertitle-job">
								<a href="<?php echo base_url('gate-keeper/change-password'); ?>" type="button" class="btn btn-info btn-sm me-2">Change Password</a>
								<a href="<?php echo base_url('gate-keeper/logout'); ?>" type="button" class="btn btn-danger btn-sm me-2">Logout</a>
							</div>
						</div>
