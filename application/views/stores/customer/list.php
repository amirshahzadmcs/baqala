                ...
                <div class="row align-items-center">
					...
					<div class="col-sm-6">
						<div class="float-end d-none d-sm-block">
							<a href="<?php echo base_url('add-customer');?>" class="btn btn-success">Add Customer</a>
						</div>
					</div>
                </div>
            </div>
								...
								<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
									...
									<tbody>
										...
										<tr>
											...
											<td><?php echo $cust->aadhar;?></td>
											<td><?php echo $cust->scheme_type;?></td>
											<td><?php echo $cust->status;?></td>
											<td><?php echo $cust->created;?></td>
											<td><?php echo $cust->modified;?></td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
