<h6>Upload Medical Certificate of <span class="text-primary"><?php echo $name;?></span></h6>
<form id="upload_form" action="<?php echo base_url('hiring-agency/cv/upload-medical-certificates'); ?>" method="POST" enctype="multipart/form-data">
	...
	<div class="row">
		<div class="form-group col-lg-12 col-md-12 col-12 mb-3">
			<label for="attachments">Upload Certificate<span class="text-danger">*</span></label>
