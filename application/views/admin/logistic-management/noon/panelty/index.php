		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Noon Penalty Summary</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/noon-panelty/list'); ?>">Noon Penalty Summary</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<?php if (check_action_permission(get_user_role(), 'noon_daily_penelty', 'print_panelty_report')): ?>
						<div class="btn-group ms-2 float-end">
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a type="button" class="dropdown-item" title="Penalty Report" data-bs-toggle="modal" data-bs-target="#exportModal">Penalty Report</a>
								<!--<div class="dropdown-divider"></div> -->
							</div>
						</div>
					<?php endif;
					if (check_action_permission(get_user_role(), 'noon_daily_penelty', 'import_file')): ?>
										...
										<tr>
											...
											if (!empty($visibleTableColumns)) {
												foreach ($visibleTableColumns as $column) {
													$styleSet = ($column == 'local_date') ? "align='center'" : " align='center'";
											?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="bulkImportModalLabel">Noon Penalty Summary</h5>
				...
				<form id="delivery_bulk_form" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="row px-3">
						<div class="col-md-12 col-sm-12 mb-3 form-group">
							<label for="summary_date">Penalty Date<span class="text-danger">*</span></label>
							<div class="position-relative">
								<input type="date" class="form-control" name="summary_date" id="summary_date" placeholder="Select Date" required>
							</div>
						</div>
						<div class="col-md-12 col-sm-12 mb-3 form-group">
						...
						<div class="col-md-12">
							...
							<p style="text-align: center;"><a type="button" href="<?php echo base_url('admin_assets/samples/noon_panelty.xlsx'); ?>" class="btn bt btn-link text-success" target="_blank" download>Download sample file</a></p>
						</div>
...
<div class="modal fade" id="exportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="exportModalLabel">Export Penalty Entries</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="alert alert-info custom-export-alert" role="alert">Current filters will be applied to the exported data set.</div>
				<form id="exportForm" action="<?php echo base_url('admin/logistic-management/noon-panelty/print-order-summary'); ?>" method="POST">
...
<div class="modal fade staticBackdrop fixed-left filtersModal" id="filtersModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="#filtersModalLabel" style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-dialog-aside">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url('admin/logistic-management/noon-penelty/list'); ?>" method="get" id="filter_form">
					<div class="row">
			...
			<div class="modal-footer">
				<a href="<?php echo base_url('admin/logistic-management/noon-penelty/list'); ?>" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</a>
...
<script>
	...
	$(document).ready(function() {
		...
		function initializeDataTable() {
			...
			table = $('#summaryTable').DataTable({
				...
				"processing": true,
				"ajax": {
					url: "<?php echo base_url(); ?>admin/logistic-management/noon-penelty/ajax-list",
					type: "POST",
					data: function(d) {
	...
	$(document).ready(function() {
		$("body").on("submit", "#delivery_bulk_form", function(e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo base_url('admin/logistic-management/noon-penelty/import-file') ?>",
				data: data,
				//dataType: 'json',
				contentType: false,
				cache: false,
	...
	function getColumnForm() {
		$.ajax({
			...
			method: 'GET',
			data: {
				request_type: 'noon_daily_penelty'
			},
			success: function(response) {
	...
	$(document).ready(function() {
		...
		$('#exportForm').on('submit', function(e) {
			...
			let exportUrl = (fileFormat === 'file_format_xlsx') ?
				'admin/logistic-management/noon-penelty/export-daily-panelty' :
				'admin/logistic-management/noon-penelty/print-daily-panelty';
