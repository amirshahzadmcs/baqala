								...
								<?php
									if (!empty($visibleTableColumns)) {
										foreach ($visibleTableColumns as $column) {
											$styleSet = ($column == 'partner_id') ? 'width="115px" align="left"' : (($column == 'partner_name') ? 'width="72px" align="center"' : 'width="60px" align="center"');
								...
								?>
									<tr>
										...
										<?php
											foreach ($visibleTableColumns as $column) {
										?>
											<td <?php echo ($column == 'partner_id') ? 'width="115px" align="left"' : (($column == 'partner_name') ? 'width="72px" align="center"' : 'width="60px" align="center"');?> style="border-bottom:1px dashed #ddd">
											<?php	
