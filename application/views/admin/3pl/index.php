		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>3PL Rider Applications</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/3p-fleet/applications'); ?>">Applications</a></li>
				...
				<div class="float-end d-sm-block">
					...
					<div class="btn-group ms-2 float-end">
						...
						<div class="dropdown-menu dropdown-menu-end">
							...
							<a type="button" class="dropdown-item" title="Export Applications" data-bs-toggle="modal" data-bs-target="#exportModal">Export Applications</a>
							<!-- <div class="dropdown-divider"></div> -->
						</div>
											...
											<tr>
												...
												if (!empty($visibleTableColumns)) {
													foreach ($visibleTableColumns as $column) {
														...
														if ($column == 'referrer_full_name' || $column == 'rider_full_name') {
															$styleSet = "align='left'";
														} else {
	...
	<div class="modal-dialog modal-dialog-aside">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="<?php echo base_url('admin/3p-fleet/applications'); ?>" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</a>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<img id="modalImage" src="" style="max-width:100%; max-height:70vh; border-radius:5px;" />
			</div>
			<div class="modal-footer">
				<a href="#" id="downloadBtn" class="btn btn-success" download>Download</a>
...
<div class="modal fade" id="exportModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="exportModalLabel">Export 3PL Applications</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="alert alert-info custom-export-alert" role="alert">Current filters will be applied to the exported data set.</div>
				<form id="exportForm" action="<?php echo base_url('admin/3p-fleet/export-excel'); ?>" method="POST">
...
<script>
	...
	$(document).ready(function() {
		...
		function initializeDataTable() {
			...
			table = $('#summaryTable').DataTable({
				...
				"processing": true,
				"ajax": {
					url: "<?php echo base_url(); ?>admin/3p-fleet/ajax-list",
					type: "POST",
					data: function(d) {
	...
	function getColumnForm() {
		$.ajax({
			...
			method: 'GET',
			data: {
				request_type: 'threepl_rider_applications'
			},
		...
		if (inputCount > 0) {
			Swal.fire({
				...
				if (result.isConfirmed) {
					changeActionAndSubmit('admin/3p-fleet/delete');
				} else {
			...
			if (result.isConfirmed) {
				...
				Swal.fire({
					...
					if (confirmResult.isConfirmed) {
						...
						$.ajax({
							url: '<?= base_url("admin/3p-fleet/delete-datewise") ?>',
							type: 'POST',
							data: {
								date: date
							},
