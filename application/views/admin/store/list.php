		 ...
		 <div class="row align-items-center">
				 ...
				 <div class="col-sm-6">
						<div class="float-end d-sm-block">
							...
							<?php } ?>
							&nbsp;
							<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/store/add')?>"><i class="fa fa-plus"></i> Add Own Store</a>
							<a class="btn btn-custom-success btn-sm pull-right" title="Third Party Store" href="<?php echo base_url('admin/store/third-party')?>"><i class="fa fa-plus"></i> Add Franchisee Store</a>
						</div>
...
$(document).ready(function() {
	$('#store-table').dataTable({
		...
		"fixedHeader": true,
		"ajax":{
			url:"<?php echo base_url();?>admin/store_manage/get_list",
			type:"POST"
		},
		"columnDefs":[
			{
...
function deleteAction() {
	...
	if(inputCount > 0){
		if (confirm("Do you want to delete selected store?") == true) {
			changeActionAndSubmit('admin/store_manage/delete');
		} else {
