...
<html lang="ae">
	<head>
		...
		<title>Maha Al Fala - Monthly Revenue Report</title>
		<style>
								...
								<table class="table" width="100%" border="1" cellspacing="0" cellpadding="3">
									...
									if (!empty($reports['details'])) {
										foreach ($reports['details'] as $report) {
											...
											$deliveries = (int) $report['total_orders'];
											...
											$totals['avg_deliveries_sum'] += $report['avg_orders'];
									...
									?>
											<tr class="item-list">
												...
												<td style="text-align:center;"><?php echo $report['driver_id']; ?></td>
												...
												<td style="text-align:center;"><?php echo round($report['avg_orders']); ?></td>
