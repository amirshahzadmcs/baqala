			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<?php echo form_open("admin/hr/employees/update/step-5", array("id" => "employee_form", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
							...
							<div class="row size-inner-section px-2 py-4 mx-2">
                                ...
                                <div class="col-md-8 col-sm-12 mb-2 form-group">
									...
									<div class="">
										<div class="mb-3">
											<input class="form-check-input" type="radio" name="bank_account_type" id="bank_account_type1" value="Cash" <?php echo ($emp_detail->payment_type == 'Cash') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type1">
											Cash
											</label>
											<input class="form-check-input ms-3" type="radio" name="bank_account_type" id="bank_account_type2" value="Bank" <?php echo ($emp_detail->payment_type == 'Bank') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type2">
											Bank
											</label>
											<input class="form-check-input ms-3" type="radio" name="bank_account_type" id="bank_account_type3" value="Cheque" <?php echo ($emp_detail->payment_type == 'Cheque') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type3">
											Cheque
											</label>
											<input class="form-check-input ms-3" type="radio" name="bank_account_type" id="bank_account_type4" value="International Transfer" <?php echo ($emp_detail->payment_type == 'International Transfer') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type4">
											International Transfer
											</label>
											<input class="form-check-input ms-3" type="radio" name="bank_account_type" id="bank_account_type5" value="STC Pay" <?php echo ($emp_detail->payment_type == 'STC Pay') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type5">
											STC Pay
											</label>
											<input class="form-check-input ms-3" type="radio" name="bank_account_type" id="bank_account_type6" value="" <?php echo ($emp_detail->payment_type == '') ? ' checked ' : '' ?> style="vertical-align: top;margin-right: 3px;">
											<label class="form-check-label" for="bank_account_type6">
											None
											</label>
										</div>
									</div>
									...
									<div id="payment_type_detail">
										...
										<div class="row border">
											...
											<div class="col-md-4 col-sm-12 mb-2 form-group">
												...
												<select class="form-select" name="payment_type_detail[country]" id="bank_country">
										...
										<?php } ?>
										<?php if($emp_info->payment_type == 'STC Pay'){ ?>
							...
							<div class="row size-inner-section px-2 py-4 mx-2">
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
									...
									<select class="form-select" data-parsley-allselected="true" name="gosi_contract_status" id="gosi_contract_status">
                                ...
                                <div class="col-md-4 col-sm-12 mb-2">
									...
									<select class="form-select" data-parsley-allselected="true" name="gosi_deductible" id="gosi_deductible">
							...
							<div class="row size-inner-section px-2 py-4 mx-2">
                                ...
                                <div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="qiwa_contract_status" id="qiwa_contract_status">
										<option value="">Select Gosi Contract Status</option>
							...
							<div class="twitter-bs-wizard">
								<ul class="pager wizard twitter-bs-wizard-pager-link">
									<li class="previous"><a href="<?php echo ($emp_detail->id > 0) ? base_url('admin/hr/employees/add/step-4/'.$emp_detail->id) : base_url('admin/hr/employees/add/step-1'); ?>" class="btn btn-custom-success"><i class="mdi mdi-arrow-left me-1"></i> Prevoius </a></li>
