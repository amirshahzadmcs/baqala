		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-none d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'sub_category', 'delete')): ?>
...
<div class="container-fluid">
	<div class="page-content-wrapper">
		<div class="row">
			<?php if (check_action_permission(get_user_role(), 'sub_category', 'add')): ?>
				<div class="col-4">
					<div class="card">
						<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="subcategory_name" placeholder="Category Name" name="subcategory_name" required>
											<div class="invalid-feedback">
			...
			<?php endif; ?>
			<div class="<?php echo check_action_permission(get_user_role(), 'sub_category', 'add') ? 'col-8' : ''; ?>">
				<div class="card">
					<div class="card-body">
						<div>
...
<script>
	$(document).ready(function() {
		$('#datatable-rack').dataTable({
			...
			"order": [],
			"ajax": {
				url: "<?php echo base_url(); ?>admin/assets/sub-category/ajax-list",
				type: "POST"
			},
			"columnDefs": [{
				"targets": [0, 1, 2, 3, 4, 5],
