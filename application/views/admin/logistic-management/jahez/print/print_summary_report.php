				...
				<td>
					<table class="table" width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size: 12px;">
						<tr>
							...
							<td colspan="4" valign="middle" style="text-align:right;color:red;">Jahez - Daily Delivery Summary Report <?php echo ($data_range !== '') ? '('. $data_range .')' : '';?></td>
							<td colspan="2" valign="middle" style="text-align:right;color:red;">Completed Deliveries </td>
							<td valign="middle" style="text-align:center;background-color:#c6efce;color:green;"><strong><?= $completed_delv_count['total_deliveries'];?></strong></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					...
					<table class="table" width="100%" border="1" cellspacing="0" cellpadding="5">
						<tr style="background-color: #f5d880;">
							...
							<td valign="top" style="width: 9%;text-align:center;"><strong>Rider ID</strong></td>
							<td valign="top" style="width: 8%;text-align:center;"><strong>Emp ID</strong></td>
							<td valign="top" style="width: 24%;text-align:center;"><strong>Employee Name</strong></td>
							...
							<!-- <td valign="top" style="width: 9%;text-align:center;"><strong>Is Free Order</strong></td> -->
						</tr>
						<?php if(count($reports) > 0){ ?>
						...
						<tr class="item-list">
							...
							<td valign="top" style="text-align:center;"><?= isset($report['emp_no']) ? $report['emp_no'] : '[NA]'; ?></td>
							<td valign="top" style="text-align:left;"><?= isset($report['full_name']) ? $report['full_name'] : '[NA]'; ?></td>
							<td valign="top" style="text-align:center;"><?= ($report['order_date']) ? date("d-m-Y", strtotime($report['order_date'])) : 'NA'; ?></td>
							<td valign="top" style="text-align:center;"><?php echo ($report['total_deliveries'] < 15) ? '<span style="color:red;"><b>'.$report['total_deliveries'] .'</b></span>' : '<span style="color:green;"><b>'.$report['total_deliveries'].'</b></span>';?></td>
							<td valign="top" style="text-align:right;"><?= $report['total_amount']; ?></td>
							<td valign="top" style="text-align:right;"><?= $report['total_price']; ?></td>
							<td valign="top" style="text-align:right;"><?= $report['total_fine']; ?></td>
							<td valign="top" style="text-align:right;"><?= $report['total_reversal']; ?></td>
