		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<a class="btn btn-custom-success btn-sm ms-1 pull-right" title="Print" href="javascript:window.print()"><i class="fa fa-print"></i> Print</a>
					<!--
							...
							<tr>
								<td colspan="3" class="pb-0">
									<table class="table table-bordered mb-0" width="100%" border="1" cellspacing="0" cellpadding="0" style="border: 1px solid #878787;">
										...
										<tr>
											<td class="text-start"><?= $item_row;?></td>
											...
											<td class="text-start"><?= $product->approved_unit;?></td>
											<td class="text-start"><?= $product->unit_price;?></td>
											<td class="text-start"><?= $product->amt_excl_vat;?></td>
											<td class="text-start"><?= $product->vat_amt;?></td>
											<td class="text-start"><?= $product->amt_incl_vat;?></td>
										</tr>
