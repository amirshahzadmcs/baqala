		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Add Attendance Restrictions</h4>
								...
								<div class="tab-pane active" id="home1" role="tabpanel">
									<div class="row size-inner-section px-2 py-4">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											...
											<input class="checkbox" type="checkbox" id="is_allowed_ips" name="is_allowed_ips" checked style="margin-right: 10px;height: 25px;width: 25px;">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group if-ip-checked">
											...
											<textarea id="allowed_ips" class="form-control" rows="2" autoresize="" name="allowed_ips" required cols="50" required style="height: 68px;"></textarea>
										</div>
										<hr>
										<div class="col-md-6 col-sm-12 mb-3 form-group">
											<label for="is_location_restricted d-block">Restricted By Location Range</label>
											<div class="bg-light p-1">
											<input class="checkbox" type="checkbox" id="is_location_restricted" name="is_location_restricted" checked style="margin-right: 10px;height: 25px;width: 25px;">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group if-location-checked">
											...
											<div id="mapMsg"></div>
											<input id="maplng" class="long-input" name="map[longitude]" type="hidden" required>
											<input id="maplat" class="lat-input" name="map[latitude]" type="hidden" required>
											<input id="place_id" class="place-input" name="map[place_id]" type="hidden" required>
											<input id="map_location" class="map-input" name="map_location" type="hidden" required>
										</div>
										<div class="col-md-6 col-sm-12 mb-2 form-group if-location-checked">
											<label for="location_range">Range of the Sign </label>
											<div class="input-group">
												<input type="text" id="location_range" name="location_range" class="form-control" required style="height:38px !important">
										...
										<div class="col-md-6 col-sm-12 mb-2 form-group">
											...
											<div class="bg-light p-1">
											<input class="checkbox" type="checkbox" id="is_photo_required" name="is_photo_required" checked style="margin-right: 10px;height: 25px;width: 25px;">
