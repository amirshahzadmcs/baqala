...
#transferTable thead tr th, #transferTable tbody tr td{
	white-space: nowrap;
}
.batch-detail-body {
    overflow-x: scroll;
			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/hr/employee-transfer/index'); ?>">Employee Transfer</a></li>
	...
	<div class="page-content-wrapper">
		...
		<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url('admin/hr/employee-transfer/index'); ?>" method="get" id="filter_form">
							<div class="row">
								...
								<div class="form-group col-lg-4 col-md-4 col-12" style="margin-top: 28px;">
									...
									<a href="<?php echo base_url('admin/hr/employee-transfer/index'); ?>" class="btn btn-danger">Reset Filter</a>
								</div>
							</div>
						</form>
					</div>
				...
				<div class="card">
					<div class="card-body">
						<form id="myform" name="myform" method="post" action="" style="overflow: auto;">
							<table id="transferTable" class="table table-striped table-bordered jambo_table bulk_action text-center" style="width:100%">
								<thead>
									<tr>
										<th>S.No.</th>
										<th>Batch No.</th>
...
<script>
	function initializeDataTable() {
		...
		$('#transferTable').dataTable({
			...
			"fixedHeader": true,
			"ajax":{
				url:"<?php echo base_url();?>admin/hr/employee-transfer/ajax-list?batch_no=<?php echo $this->input->get('batch_no')?>&start_date=<?php echo $this->input->get('start_date')?>&end_date=<?php echo $this->input->get('end_date')?>",
				type:"POST"
			},
			"columnDefs":[
				{
	...
	function viewBatchDetail(batch_no) {
		...
		$.ajax({
			url: '<?php echo base_url('admin/hr/employee-transfer/view-batch-detail'); ?>',
			method: 'GET',
