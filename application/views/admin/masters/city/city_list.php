        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <div class="float-end d-sm-block">
                    <?php if (check_action_permission(get_user_role(), 'cities', 'delete')): ?>
                    ...
                    <?php endif;
                    if (check_action_permission(get_user_role(), 'cities', 'add')): ?>
                        <a class="btn btn-custom-success btn-sm pull-right" title="Add" href="<?php echo base_url('admin/master/city/add') ?>"><i class="fa fa-plus"></i> Add</a>
                    <?php endif; ?>
    ...
    <div class="page-content-wrapper">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open('admin/master/city/delete', array("id" => "delete_form")); ?>
                            ...
                            <tbody>
                                ...
                                foreach ($cities as $city) { ?>
                                    <tr>
                                        ...
                                        <td><?= check_action_permission(get_user_role(), 'cities', 'add') ? '<a class="btn btn-outline-secondary btn-custom-light btn-sm edit" data-toggle="tooltip" title="Edit" href="' . base_url() . 'admin/master/city/add?id=' . $city->id . '"><i class="mdi mdi-pencil font-size-18"></i></a>' : ''; ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
