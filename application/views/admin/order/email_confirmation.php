...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="padding:15px 0px; font-size:24px; font-weight:bold; color:#666666;">ORDER CONFIRMATION</td>
  </tr>
  <tr>
...
Thank you for Shopping with Baqala Station, your order has been confirmed and your Order details are shown below for your reference :</td>
  </tr>
  <tr>
    <td style="border:1px solid #D9D9D9;">
	<table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr>
        <td colspan="9" align="center" style="font-size:18px; font-weight:bold; padding:15px 0px;">ORDER SUMMARY</td>
      </tr>
	...
	?>
	  <tr>
        ...
        <td valign="top" style="border-top:1px solid #D9D9D9;"><?php echo $product['quantity'];?></td>
      ...
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="right" valign="top" style="font-size:15px;"><?php echo sprintf("%.2f",$result['order']['shipping_charge']);?></td>
          </tr>
          <tr>
  ...
  <tr>
    <td style="padding:15px 0px; font-size:16px; line-height:25px;">NOTE : We will update you with Tracking Details, once the product will dispatched from Baqala Station.<br />
      For more visit your 
	  <a href="https://www.baqalastation.com" style="color:#38C2EB; text-decoration:none;"><strong>www.baqalastation.com</strong></a></td>
  </tr>
  <tr>
    <td style="background:#000; height:2px"></td>
  </tr>
