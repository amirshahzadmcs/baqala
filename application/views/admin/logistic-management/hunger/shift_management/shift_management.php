		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6 message_place">
				<div class="float-end d-sm-block">
					<?php if(check_action_permission(get_user_role(), 'shift_management', 'print_dailyShiftReport')):?>
					...
					<?php endif; if(check_action_permission(get_user_role(), 'shift_management', 'print_weeklyShiftReport')):?>
					...
					<?php endif; if(check_action_permission(get_user_role(), 'shift_management', 'shiftAssign')):?>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url('admin/logistic-management/hunger/rider-shift'); ?>" method="get" id="filter_form">
							<div class="row">
							...
							<div class="row mt-2">
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									...
									<a href="<?php echo base_url('admin/logistic-management/hunger/rider-shift'); ?>" class="btn btn-danger btn-md float-end">Reset Filter</a>
								</div>
							</div>
						</form>
					</div>
	...
	<div class="modal-dialog modal-dialog-aside">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div id="searchRider">
					<div class="size-inner-section px-1 py-1 mx-1 alert_box">
						<?php echo form_open("admin/logistic-management/hunger/search-rider", array("id" => "searchRiderForm", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
						<div class="row p-2">
							<div class="col-md-12 col-sm-12 mb-2 form-group">
								...
								<div class="input-group find_rider">
									...
									<button type="submit" class="btn-custom-success btn-sm input-group-append" title="Sreach">Search</button>
			...
			<div class="footerArea" style="display:none"></div>
		</div>
		<!-- /.modal-content -->
	</div>
	<!-- /.modal-dialog -->
...
<!-- Edit OR Change Shift -->
<div class="modal fade fixed-left changeShiftModal" id="changeShiftModal" data-bs-backdrop="static" aria-labelledby="#replacementModalModalLabel2" style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-dialog-aside">
		<div class="modal-content">
			<div class="modal-header justify-content-between">
				<h5 class="modal-title mt-0" id="changeShiftModalLabel">Change / Edit Shift</h5>
				<button type="button" class="btn-close modal-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="alert_box"></div>
				<div id="changeShiftDeatil" style="display: none;">
