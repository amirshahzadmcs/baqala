				...
				<td>
					<table class="table" width="100%" border="0" cellspacing="1" cellpadding="3" style="font-size: 10px;">
						...
						<tr>
							...
							<td valign="middle" style="width: 13%;text-align:center;color:green;background-color:#c6efce;">Total Basic Payments</td>
							<td valign="middle" style="width: 12%;text-align:center;color:green;"><?php echo $totalBasicPayments; ?></td>
						</tr>
						...
						<tbody>
							...
							?>
								<tr>
									...
									?>
										<td <?php echo ($cleanedColumn == 'full_name') ? ' align="left" ' : (($cleanedColumn == 'emp_no' || $cleanedColumn == 'rider_id' || $cleanedColumn == 'id' || $cleanedColumn == 'emp_id') ? ' align="center" ' : ' align="right" ');?> style="border-bottom:1px dashed #ddd">
											<?php 
