				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'invoice_month', 'from_date', 'to_date', 'contract_name', 'vat_no', 'iban_no', 'completed_orders', 'basic_payment', 
                            'acceptance_rate_penalties', 'contact_rate_penalties', 'stacking_deduction', 
                            'declined_penalties_day_logic', 'google_capped_after', 'amount_exlc_vat_before_bonus', 
                            '3pl_bonus', 'amount_exlc_vat_with_bonus', 'vat', 'amount_incl_vat', 'rider_scoring', 
                            'rider_basic', 'monthly_balance', 'total_deduction', 'net_ftr', 'added_by', 
