			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<?php echo form_open("admin/hr/employees/update/step-3", array("id" => "employee_form", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
							<input type="hidden" id="id" name="id" value="<?php echo $emp_detail->id;?>" required />
							<!-- Tab panes -->
							<div class="row size-inner-section px-2 py-4 mx-2">
								<h4 class="header-title">Education</h4><hr>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="edu_degree">Qualification</label>
									<select class="form-select select2" data-parsley-allselected="true" name="edu_degree" id="edu_degree">
							...
							<div class="row size-inner-section px-2 py-4 mx-2">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="work_operational_date">Active in operation (Gregorian) <span class="text-danger">*</span></label>
									<input type="date" class="form-control" id="work_operational_date" name="work_operational_date" value="<?php echo $emp_detail->work_operational_date;?>" required />
								</div>
								
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="department">Department <span class="text-danger">*</span></label>
									<select class="form-select select2" data-parsley-allselected="true" name="department" id="department" required>
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="designation" id="designation" required>
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="work_line_manager" id="work_line_manager">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="department_head" id="department_head">
										<option value="">Select Line Manager First</option>
									</select>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="employment_type">Employment Type</label>
									<select class="form-select select2" data-parsley-allselected="true" name="employment_type" id="employment_type">
                                ...
                                <div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="work_location" id="work_location" required>
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select" name="work_country" id="work_country" required>
                                ...
                                <div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<select class="form-select select2" data-parsley-allselected="true" name="work_city" id="work_city" required>
							...
							<div class="row size-inner-section px-2 py-4 mx-2">
								...
								<div class="col-md-12">
									...
									<ul class="nav nav-tabs nav-tabs-custom" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" data-bs-toggle="tab" href="#currentSalary" role="tab">
												<span class="d-none d-sm-block">Current</span> 
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#prevSalary" role="tab">
												<span class="d-block d-sm-none"><i class="far fa-user"></i></span>
												<span class="d-none d-sm-block">Salary Logs</span> 
											</a>
										</li>
									</ul>
									<div class="tab-content p-3 px-0 text-muted">
										<div class="tab-pane active" id="currentSalary" role="tabpanel">
											<?php if($emp_detail->basic_salary > 0){ ?>
												<div class="active-salary">
													<table class="table border" id="currentSalaryTable">
														<thead>
															<tr class="bg-light">
																<th>Basic Salary</th>
														...
														<tbody>
															<tr>
																<td><?php echo ($emp_detail->basic_salary > 0) ? $emp_detail->basic_salary : '-';?></td>
																<td><?php echo ($emp_detail->housing_allowance > 0) ? $emp_detail->housing_allowance : '-';?></td>
																<td><?php echo ($emp_detail->transport_allowance > 0) ? $emp_detail->transport_allowance : '-';?></td>
																<td><?php echo ($emp_detail->food_allowance > 0) ? $emp_detail->food_allowance : '-';?></td>
																<td><?php echo ($emp_detail->mobile_allowance > 0) ? $emp_detail->mobile_allowance : '-';?></td>
																<td><?php echo ($emp_detail->other_allowance > 0) ? $emp_detail->other_allowance : '-';?></td>
																<td><?php echo ($emp_detail->total_package > 0) ? $emp_detail->total_package : '-';?></td>
																<td>
																	<div class="btn-group">
																		...
																		<div class="dropdown-menu dropdown-menu-start" style="margin: 0px;">
																			<a class="dropdown-item" href="javascript:;" data-empid="<?php echo $emp_detail->id;?>" data-type="Update" onclick="addSalaryForm(this)">Edit</a>
																		</div>
																	</div>
																</td>
															</tr>
											...
											<?php }else{ ?>
												<div class="text-center m-auto p-3">
													...
													<button type="button" class="btn btn-outline-secondary" data-type="New" data-empid="<?php echo $emp_detail->id;?>" onclick="addSalaryForm(this)"><i class="fa fa-plus"></i> Add Salary</button>
												</div>
											<?php } ?>
										</div>
										<div class="tab-pane" id="prevSalary" role="tabpanel">
											<?php if(count($salary_logs) > 0){ ?>
												<div class="active-salary">
													<table class="table border" id="prevSalaryTable">
														<thead>
															<tr class="bg-light">
																<th>#</th>
																<th>Basic Salary</th>
														...
														<tbody>
															<?php
															$counter = 1;
															foreach ($salary_logs as $logs) {
																echo '<tr>';
																echo '<td>' . $counter++ . '.</td>';
																
																// Decode JSON log_detail field
																$log_detail = json_decode($logs['log_detail'], true);
																
																// Output each column value, handling if value is zero or not set
																echo '<td>' . (isset($log_detail['basic_salary']) && $log_detail['basic_salary'] > 0 ? $log_detail['basic_salary'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['is_housing_provided']) && $log_detail['is_housing_provided'] == 'on' ? 'Yes' : 'No') . '</td>';
																echo '<td>' . (isset($log_detail['housing_allowance']) && $log_detail['housing_allowance'] > 0 ? $log_detail['housing_allowance'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['transport_allowance']) && $log_detail['transport_allowance'] > 0 ? $log_detail['transport_allowance'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['food_allowance']) && $log_detail['food_allowance'] > 0 ? $log_detail['food_allowance'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['mobile_allowance']) && $log_detail['mobile_allowance'] > 0 ? $log_detail['mobile_allowance'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['other_allowance']) && $log_detail['other_allowance'] > 0 ? $log_detail['other_allowance'] : '-') . '</td>';
																echo '<td>' . (isset($log_detail['total_package']) && $log_detail['total_package'] > 0 ? $log_detail['total_package'] : '-') . '</td>';
																
																// Format the date if it exists; otherwise, display 'NA'
																echo '<td>' . (!empty($logs['created_at']) ? date('d-m-Y H:i:s', strtotime($logs['created_at'])) : 'NA') . '</td>';
																echo '<td>
																		<div class="btn-group">
																			<button type="button" class="btn btn-link btn-sm waves-light waves-effect dropdown-toggle py-0" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="mdi mdi-dots-horizontal font-size-20 text-dark"></i>
																			...
																			<div class="dropdown-menu dropdown-menu-start" style="margin: 0px;">
																				<a class="dropdown-item" href="javascript:;" data-logid="'. $logs['id'] .'" data-type="Detail" onclick="viewSalaryDetail(this)">Detail</a>
																			</div>
																		</div>
																	</td>';
																echo '</tr>';
                                ...
                                <div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="radio" name="annual_leave_entitlement" id="annual_leave" value="0" <?php echo ($emp_detail->annual_leave_entitlement == '0') ? ' checked ' : '' ?>>
											<label class="form-check-label" for="annual_leave">
												0
											</label>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="radio" name="annual_leave_entitlement" id="annual_leave2" value="21" <?php echo ($emp_detail->annual_leave_entitlement == '21') ? ' checked ' : '' ?>>
											<label class="form-check-label" for="annual_leave2">
												21
											</label>
										</div>
										<div class="form-check mb-3">
											<input class="form-check-input" type="radio" name="annual_leave_entitlement" id="annual_leave3" value="30" <?php echo ($emp_detail->annual_leave_entitlement == '30') ? ' checked ' : '' ?>>
											<label class="form-check-label" for="annual_leave3">
												30
											</label>
										</div>
									</div>
							...
							<div class="twitter-bs-wizard">
								<ul class="pager wizard twitter-bs-wizard-pager-link">
									<li class="previous"><a href="<?php echo ($emp_detail->id > 0) ? base_url('admin/hr/employees/add/step-2/'.$emp_detail->id) : base_url('admin/hr/employees/add/step-1'); ?>" class="btn btn-custom-success"><i class="mdi mdi-arrow-left me-1"></i> Prevoius </a></li>
...
<div class="modal fade fixed-left salaryModal" aria-labelledby="#salaryModalFullscreenLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-aside">
        <div class="modal-content">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		$('#employee_form').data('initial-state', $('#employee_form').serialize());
	...
	function getDepartmentHead(){
		...
		$.ajax({
			...
			data: {
				emp_id: lm_id,
				main_emp_id: '<?php echo $emp_detail->id; ?>'
			},
			type: "POST",
	...
	function addContractForm(identifier) {
		...
		$.ajax({
			...
			data: {'emp_id': emp_id,'redirect':'add'},
			//dataType: "json",
	...
	/*----- Salary Modal -------*/
	function addSalaryForm(identifier) {
		let emp_id = $(identifier).data('empid');
		let type = $(identifier).data('type');
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('admin/hr-module/employees/Employee/add_salary_form');?>",
			data: {'emp_id': emp_id,'redirect':'edit'},
			//dataType: "json",
			success: function (response) {
				//console.log(response);
				$('.salaryModal').modal('show');
				$('.salaryModal .modal-content').html(response);
				$('#salaryModalFullscreenLabel').html(type + ' Salary');
			},
			error: function (request, error) {
				console.log(" Can't do because: " + JSON.stringify(request));
				$('.salaryModal .modal-content').after(JSON.stringify(request));
			},
		});
	}
	
	function viewSalaryDetail(identifier) {
		let id = $(identifier).data('logid');
		let type = $(identifier).data('type');
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('admin/hr/employees/salary-log_detail');?>",
			data: {'id': id},
			//dataType: "json",
			success: function (response) {
				//console.log(response);
