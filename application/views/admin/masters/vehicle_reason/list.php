        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="page-title">
                    <h4>Vehicle Reasons</h4>
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/master/vehicle-reason'); ?>">Vehicle Reasons</a></li>
            ...
            <div class="col-sm-6">
                <div class="float-end d-sm-block">
                    <?php if (check_action_permission(get_user_role(), 'vehiclesstatusreasons', 'add')): ?>
                    ...
                    <?php endif;
                    if (check_action_permission(get_user_role(), 'vehiclesstatusreasons', 'edit')): ?>
    ...
    <div class="page-content-wrapper">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open('admin/master/vehicle-reason/delete', array("id" => "delete_form")); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#itemTable').dataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url(); ?>admin/master/vehicle-reason/get-list?type=vehicle_reason",
                type: "POST",
    ...
    $(document).ready(function() {
        $('#load_add_modal').click(function() {
            $.ajax({
                url: "<?php echo base_url('admin/master/vehicle-reason/add'); ?>",
                type: 'GET',
    ...
    function editModal(id) {
        $.ajax({
            url: "<?php echo base_url('admin/master/vehicle-reason/edit'); ?>",
            type: 'POST',
            data: {
                'id': id
            },
