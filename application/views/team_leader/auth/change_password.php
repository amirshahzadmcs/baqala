            ...
            <div class="page-content-wrapper">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <?php $this->load->view('team_leader/layout/profile-sidebar'); ?>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="card p-3">
                            <div class="card-body" style="min-height: 506px;">
                                <?php $this->load->view('team_leader/partials/alert'); ?>

                                <form method="post" action="<?php echo base_url('team-leader/update-password') ?>"
