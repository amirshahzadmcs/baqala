<div class="modal-header">
	<h5 class="modal-title mt-0" id="addRiderModalLabel">Unallot Aggregator ID</h5>
...
<div class="modal-body">
	<div class="mt-2">
		...
		<div class="size-inner-section px-1 py-1 mx-1">
			<div class="card-header">Fill Unallotment Information</div>
			<?php echo form_open("admin/logistic-management/rider/save-unallot", array("id" => "riderProfileForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
				...
				<div class="row p-2">
					...
					<div class="col-md-12 col-sm-12 mb-2 form-group">
						<label for="reason">Unallot Reason <span class="text-danger">*</span></label>
...
<div class="modal-footer" id="searchModalFooter">
	...
	<button type="submit" form="riderProfileForm" class="btn btn-custom-success">Save</button>
</div>
...
<script>
	$(document).ready(function () {
        ...
        $('#riderProfileForm').submit(function (e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to unallot this rider? This will also remove this rider from team.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, unallot it!'
            }).then((result) => {
                if (result.isConfirmed) {
                    var formData = new FormData($(this)[0]);
                    $.ajax({
                        url: '<?php echo base_url('admin/logistic-management/rider/save-unallot');?>',
                        type: 'POST',
                        data: formData,
                        dataType: 'json',
                        processData: false,
