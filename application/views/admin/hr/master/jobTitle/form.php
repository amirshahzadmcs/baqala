			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/hr/master/designations">Manage Designations</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if ($this->customer->userd($admin_id)->role == "Admin") { ?>
						<a class="btn btn-sm btn-custom-white pull-right" title="Back" href="<?php echo base_url(); ?>admin/hr/master/designations"><i class="fa fa-reply"></i> Back</a>
					<?php } ?>
					&nbsp;
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open("admin/hr/master/designations/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
						...
						<div class="row">
							<div class="col-md-6 col-sm-12 mb-2 form-group">
								...
								<select name="department_id[]" id="department" class="form-select select2" multiple>
							...
							<div class="col-md-6 col-sm-12 form-group mb-2">
								...
								<input type="text" id="arabic_name" name="arabic_name" class="form-control rtl-input">
							</div>
							...
							<div class="col-md-12 col-sm-12 form-group mb-2">
								...
								<textarea id="description" class="form-control" name="description" rows="3" placeholder="Write description here."></textarea>
							</div>
