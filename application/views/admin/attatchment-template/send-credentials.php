...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Signup Mail | Baqala Station</title>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Thank you for choosing Baqala Station. Use the following username and password to login in your account.</p><br>
                                <h4 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">Username: <?php echo $emp_no; ?></h4><br>
                                <h4 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">Password: <?php echo $password; ?></h4>
                            </td>
                        </tr>
