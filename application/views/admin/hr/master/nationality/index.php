			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Nationality List</li>
					</ol>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'nationalities', 'delete')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'nationalities', 'add')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/nationality/add') ?>"><i class="fa fa-plus"></i> Add Nationality</a>
					<?php endif; ?>
				</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			"fixedHeader": true,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/hr/master/Nationality/get_list",
				type: "POST"
			},
			"columnDefs": [{
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected nationality?") == true) {
				changeActionAndSubmit('admin/hr/master/nationality/delete');
			} else {
