		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-none d-sm-block">
					...
					<button form="agencyForm" type="submit" class="btn btn-sm btn-custom-success pull-right" title="Update"><i class="fa fa-save"></i> Update</button>
				</div>
						...
						<form class="needs-validation" method="POST" action="<?php echo base_url('admin/hr/master/agency/save');?>" enctype="multipart/form-data" id="agencyForm" novalidate>
							...
							<div class="row size-inner-section px-2 py-4">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<input type="date" class="form-control" id="agreement_s_date" name="agreement_s_date" value="<?php echo $result->agreement_s_date;?>" />
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="agreement_e_date">Agreement End Date</label>
									<input type="date" class="form-control" id="agreement_e_date" name="agreement_e_date" value="<?php echo $result->agreement_e_date;?>" />
								</div>
								<div class="col-md-4">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<input type="password" class="form-control" name="password" maxlength="55" value="******" readonly required />
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
