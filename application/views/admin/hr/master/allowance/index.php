		 ...
		 <div class="row align-items-center">
				 ...
				 <div class="col-sm-6">
						<div class="float-end d-sm-block">
							<?php if(check_action_permission(get_user_role(), 'allowance', 'delete_allowance')):?>
							...
							<?php endif; if(check_action_permission(get_user_role(), 'allowance', 'add_allowance')):?>
							&nbsp;
							<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/allowance/add')?>"><i class="fa fa-plus"></i> Add Allowance</a>
							<?php endif;?>
						</div>
...
$(document).ready(function() {
	$('#store-table').dataTable({
		...
		"fixedHeader": true,
		"ajax":{
			url:"<?php echo base_url();?>admin/HrMaster/get_allowance_list",
			type:"POST"
		},
		"columnDefs":[
			{
...
function deleteAction() {
	...
	if(inputCount > 0){
		if (confirm("Do you want to delete selected allowance data?") == true) {
			changeActionAndSubmit('admin/hr/master/allowance/delete');
		} else {
