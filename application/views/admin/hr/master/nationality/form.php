		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Nationality Master</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/hr/master/nationality">Nationality List</a></li>
			...
			<div class="col-sm-6">
					<div class="float-end d-sm-block">
						...
						<a class="btn btn-sm btn-custom pull-right" title="Back" href="<?php echo base_url(); ?>admin/hr/master/nationality"><i class="fa fa-reply"></i> Back</a>
						<?php }?>
						&nbsp;
  		...
  		<div class="page-content-wrapper">
 			 <div class="row">
 			 	<div class="col-12">
 			 		<div class="card">
 			 			<div class="card-body">
							<?php echo form_open("admin/hr/master/nationality/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
								<input type="hidden" id="id" name="id" value="<?php echo $id; ?>" />

								<div class="row">
									<div class="col-md-6 col-sm-12 mb-3 form-group">
										<label for="name">Nationality <span class="required-field">*</span></label>
										<input type="text" class="form-control" id="name" name="name" maxlength="150" value="<?php echo $name; ?>" required />
										<p class="hint">Enter Nationality</p>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="form-group mb-2">
											<label class="control-label" for="arabic_name">Nationality (Arabic)</label>
