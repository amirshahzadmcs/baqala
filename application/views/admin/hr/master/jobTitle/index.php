		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Manage Designations</li>
					</ol>
				</div>
			</div>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'designations', 'delete_job_title')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'designations', 'add_job_title')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/designations/add') ?>"><i class="fa fa-plus"></i> Add Designations</a>
					<?php endif; ?>
				</div>
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url('admin/hr/master/designations'); ?>" method="get" id="filter_form">
							<div class="row p-2">
								...
								<div class="col-md-12 px-1" style="padding-top: 10px;">
									...
									<a href="<?php echo base_url('admin/hr/master/designations'); ?>" class="btn btn-custom-danger btn-sm float-end me-2">Clear Filter</a>
								</div>
							</div>
						</form>
					</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			searching: false,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/HrMaster/get_job_title_list?title=<?php echo $this->input->get('title'); ?>&status=<?php echo $this->input->get('status'); ?>",
				type: "POST"
			},
			"columnDefs": [{
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected job title?") == true) {
				changeActionAndSubmit('admin/hr/master/designations/delete');
			} else {
