		 ...
		 <div class="row align-items-center">
				 <div class="col-sm-6">
					<div class="page-title">
						...
						<ol class="breadcrumb m-0">
							...
							<li class="breadcrumb-item active">Experience Letter List</li>
						</ol>
					</div>
				 </div>
				 ...
				 <div class="col-sm-6">
						<div class="float-end d-sm-block">
							...
							<?php } ?>
							&nbsp;
							<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/recruitment/exp-letter/add')?>"><i class="fa fa-plus"></i> Add Experience Letter</a>
						</div>
...
$(document).ready(function() {
	$('#store-table').dataTable({
		...
		"fixedHeader": true,
		"ajax":{
			url:"<?php echo base_url();?>admin/hr/recruitment/ExpLetter/get_list",
			type:"POST",
...
function deleteAction() {
	...
	if(inputCount > 0){
		if (confirm("Do you want to delete selected sim data?") == true) {
			changeActionAndSubmit('admin/hr/recruitment/exp-letter/delete');
		} else {
