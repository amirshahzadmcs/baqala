		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/master/insurance-company/list');?>">Insurance Company</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-none d-sm-block">
					<?php if(check_action_permission(get_user_role(),'insurance_companies','delete')):?>
					...
					<?php endif; if(check_action_permission(get_user_role(),'insurance_companies','add')):?>
					<button class="btn btn-custom-success btn-sm pull-right ms-2" title="Add New Company" id="addInsuranceBtn"><i class="fa fa-plus"></i> Add New Company</button>
					<?php endif;?>
				</div>
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open('admin/master/insurance-company/delete', array("id"=>"delete_form"));?>
...
$(document).ready(function() {
	$('#datatable-rack').dataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url();?>admin/master/insurance-company/ajax-list",
			type:"POST"
		},
		"columnDefs":[
			{
...
$(document).ready(function() {
	$("#addInsuranceBtn").click(function(){
		$('.insurance-modal .modal-content').html(`<div class="modal-header">
				<h5 class="modal-title mt-0">Add Insurance Company</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<form data-parsley-validate="" id="insuranceForm" method="POST" action="<?php echo base_url('admin/master/insurance-company/save');?>">
					<div class="row">
						<div class="col-md-12">
							<div class="mb-3">
						...
						<div class="col-md-12">
							<div class="mb-3">
								...
								<input type="text" class="form-control rtl-input" id="company_name_ar" name="company_name_ar" required>
								<div class="invalid-feedback">
...
function editModal(id){
	if (id > 0) {
		$.ajax({
			type: "POST",
			url: "<?php echo base_url('admin/master/insurance-company/add'); ?>",
			data: {
				'id': id,
			},
			dataType: "json",
