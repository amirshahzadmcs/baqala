			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Daily Payments</li>
					</ol>
				</div>
			</div>
	...
	<div class="page-content-wrapper">
		<div class="row">
			...
			<div class="col-12 mb-3">
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url('admin/report/popayments') ?>" method="get">
							<div class="row">
								...
								<div class="form-group col-lg-2 col-md-4 col-12 mb-3">
									...
									<select name="payment_method" id="payment_method" class="form-control select2 w-100" data-placeholder="Choose Payment Method...">
										<option value="">Select</option>
								...
								<div class="form-group col-lg-2 col-md-4 col-12 mb-3">
									...
									<select name="invoiced_by" class="form-control select2 w-100" data-placeholder="Choose Invoiced By...">
										<option value="">Select</option>
