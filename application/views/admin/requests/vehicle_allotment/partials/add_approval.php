...
<?php echo form_open("admin/hr-module/request/vehicle-allotment/save", array("id" => "addVehicleAllotmentForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#employeeSelectionButton').on('click', function() {
			$.ajax({
				url: '<?php echo base_url('admin/hr-module/request/vehicle-allotment/get-employee-list'); ?>',
				method: 'GET',
		...
		$('#addVehicleAllotmentForm').on('submit', function (e) {
			e.preventDefault();
			...
			$.ajax({
				...
				success: function (response) {
					...
					if (result.status === 'success') {
						...
						$('#addVehicleAllotmentForm')[0].reset();
