		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Experience Letter Master</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/hr/recruitment/exp-letter">Experience Letter List</a></li>
			...
			<div class="col-sm-6">
					<div class="float-end d-sm-block">
						...
						<a class="btn btn-sm btn-custom pull-right" title="Back" href="<?php echo base_url(); ?>admin/hr/recruitment/exp-letter"><i class="fa fa-reply"></i> Back</a>
						<?php }?>
						&nbsp;
 ...
 <!-- end page title -->
  ...
  <div class="container-fluid">
  		<div class="page-content-wrapper">
			<?php echo form_open("admin/hr/recruitment/exp-letter/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
 			 <div class="row">
 			 	<div class="col-12">
 			 		<div class="card">
 			 			<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="last_date">Last Working Date <span class="required-field">*</span></label>
									<input type="date" class="form-control" id="last_date" name="last_date" value="<?php echo $last_date; ?>" required />
									<p class="hint">Enter Last Working Date</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="organization">Organization <span class="required-field">*</span></label>
									<input type="text" class="form-control" id="organization" name="organization" value="<?php echo $organization; ?>" required />
									<p class="hint">Enter Organization</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="total_exp">Total Exp <span class="required-field">*</span></label>
									<input type="text" class="form-control" id="total_exp" name="total_exp" value="<?php echo $total_exp; ?>" required />
									<p class="hint">Enter Total Exp</p>
								</div>
							</div>
 			 			</div>
 			 		</div>
...
<script type="text/javascript">
	...
	$('#emp_no').on('change', function(){
		...
		// alert(id);
		$.ajax({
			url: "<?php echo base_url();?>admin/hr/recruitment/exp-letter/getEmpDetail",
			type: "GET",
			data: {"id" : id},
