		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'educations', 'delete_edu')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'educations', 'add_edu')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/education/add') ?>"><i class="fa fa-plus"></i> Add Education</a>
					<?php endif; ?>
				</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			"fixedHeader": true,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/HrMaster/get_edu_list",
				type: "POST"
			},
			"columnDefs": [{
				"targets": [0, 1, 2, 3, 4],
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected education data?") == true) {
				changeActionAndSubmit('admin/hr/master/education/delete');
			} else {
