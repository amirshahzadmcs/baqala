    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content-wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12"><?php $this->load->view('delivery/layout/profile-sidebar');?></div>
										...
										<div class="tab-pane" id="documentsTab" role="tabpanel">
											<div class="row size-inner-section p-2">
												...
												<div class="col-md-3 col-sm-12 mb-3 form-group">
													<div class="upload-div">
														<label class="font-size-11 custom-label">Profile Picture (white background) </label>
												...
												<div class="col-md-3 col-sm-12 mb-3 form-group">
													<div class="upload-div">
														<!-- File upload form -->
														<label class="font-size-11 custom-label">Iqama Image Front </label>
												...
												<div class="col-md-3 col-sm-12 mb-3 form-group">
													<div class="upload-div">
														<!-- File upload form -->
														<label class="font-size-11 custom-label">Driving Licence Front </label>
												...
												<div class="col-md-3 col-sm-12 mb-3 form-group">
													<div class="upload-div">
														<!-- File upload form -->
														<label class="mb-2 font-size-11 custom-label">IBAN Certificate (Account name and bank name must be clear) </label>
											...
											<div class="row size-inner-section p-2">
												...
												<div class="col-md-3 col-sm-12 mb-3 form-group">
													<div class="upload-div">
														<!-- File upload form -->
														<label class="mb-2 font-size-11 custom-label"><?php echo ($service_type == 'bike') ? 'Bike':'Car';?> Registration Front (Serial no. must be clear) </label>
