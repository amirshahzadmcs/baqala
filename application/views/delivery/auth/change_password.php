            ...
            <div class="page-content-wrapper">
               <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12">
						<?php $this->load->view('delivery/layout/profile-sidebar');?>
                  </div>
                  <div class="col-lg-9 col-md-9 col-sm-12">
                     <div class="card p-3">
                        <div class="card-body" style="min-height: 506px;">
                           ...
                           <form method="post" action="<?php echo base_url('delivery-partner/update-password')?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

									<div class="form-group mb-3">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" for="old_password">Old
