...
<?php 
 $cat_id = $current_detail['branch_id'];
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-12 head-info">
                                                <div class="pages-head-title">
                                                    <h2 class="d-flex align-items-center"><?php echo $parent_detail['branch_name'];?> <span class="fs-14">#<?php echo $parent_detail['branch_id'];?></span>
                                                    <div class="dropdown">
														<button type="button" class="btn dropdown-toggle"  data-bs-toggle="dropdown">
															<i class="fas fa-cog fs-12"></i>
														</button>
														<ul class="dropdown-menu">
															<li><a target="_blank" class="dropdown-item" href="<?php echo base_url('admin/accounting/chartaccounts/folder-view'); ?>"><i class="fas fa-eye text-success"></i> View</a></li>
                                                    ...
                                                    <div class="route-links"><span><?php echo $parent_detail['branch_name'];?><span class="tip-circle lazy-tip tooltipstered non observed" data-title="assets-cat"><i class="fas fa-question-circle" style="margin-left:5px;"></i></span></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4 text_rightcol">
                                        <div class="credit-wrap text-right d-inline-block align-middle">
                                            <div class="credit-container px-2 credit-overdue" style="border-color: rgb(14, 132, 84);">
                                                ...
                                                <p class="type"><?php echo ucfirst($parent_detail['journal_cat_type']);?></p>
                                            </div>
                                        </div>
							...
							<div class="row chart-of-accounts-row">
								<div class="chart-of-accounts-col col-md-4 border chart-of-accounts-col-3 px-0">
									...
									<div class="chart-of-accounts-col-3-body-container">
										<?php foreach($chart_list as $clist){ ?>
											...
											<li>
												<span class="caret <?php (in_array($clist['branch_id'], $parent_ids)) ? ' caret-down' : '';?>" onclick="quickSidebar(this)" data-id="<?php echo $clist['branch_id'];?>"><a href="<?php echo base_url('admin/chart-of-accounts/cats/'.$clist['branch_id']); ?>"><?php echo $clist['branch_name'];?></a></span>
												<ul class="nested <?php (in_array($clist['branch_id'], $parent_ids)) ? ' active' : '';?>" id="list_<?php echo $clist['branch_id'];?>" style="margin-left: 10px;">
								...
								<div class="chart-of-accounts-col col-md-8 chart-of-accounts-col-9 px-0">
									<div id="chart-of-accounts-child-board" class="chart-of-accounts-col-9-body-container">
										...
										<?php } ?>
										<a type="button" onclick="addAccount(this)" data-folderid="<?php echo $parent_detail['branch_id']; ?>" class="add-account font-weight-bold">
...
<script>
	...
	function addAccount(identifier) {
		...
		if(folderid !== ''){
			$.ajax({
				type: "post",
				url: "<?php echo base_url('admin/chart-of-accounts/add-sub-account-form');?>",
	...
	function editAccount(identifier) {
		...
		let folderid = <?php echo $parent_detail['branch_id'];?>;
		if(id !== ''){
			$.ajax({
				type: "post",
				url: "<?php echo base_url('admin/chart-of-accounts/edit-sub-account-form');?>",
