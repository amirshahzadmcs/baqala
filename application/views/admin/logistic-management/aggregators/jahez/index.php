		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Jahez Monthly Performance</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/invoices/jahez/list'); ?>">Jahez Monthly Performance</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<?php if (check_action_permission(get_user_role(), 'jahez_monthly_performance', 'import_file')): ?>
				...
				<div class="card">
					<div class="card-body">
						<table id="employeeTable" class="table table-bordered jambo_table" style="width:100%">
							...
							<tbody>
								<?php
								if (count($jahez_summary) > 0) {
									foreach ($jahez_summary as $summary) {
								?>
										<tr>
											<td>
											...
											<td align="center"><?= $summary['Total_Price']; ?></td>
											<td align="center">
											...
											<td align="center">
												<div class="btn-group ms-2">
													...
													<div class="dropdown-menu dropdown-menu-end">
														<?php if (check_action_permission(get_user_role(), 'jahez_monthly_performance', 'detail')): ?>
															<a class="dropdown-item" href="<?= base_url('admin/logistic-management/invoices/jahez/detail/' . $summary['id']); ?>">
																<i class="mdi mdi-stretch-to-page-outline me-2"></i> Detail
															</a>
															<div class="dropdown-divider"></div>
														<?php endif;
														if (check_action_permission(get_user_role(), 'jahez_monthly_performance', 'print_export_data')): ?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="bulkImportModalLabel">Jahez Monthly Performance</h5>
				...
				<form id="delivery_bulk_form" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="row px-3">
						...
						<div class="col-md-12">
							...
							<p style="text-align: center;"><a type="button" href="<?php echo base_url('admin_assets/samples/Jahez-Monthly-Performance.xlsx'); ?>" class="btn bt btn-link text-success" target="_blank" download>Download sample file</a></p>
						</div>
	...
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form id="exportForm" action="<?php echo base_url('admin/logistic-management/invoices/jahez/print-monthly-performance'); ?>" method="POST">
...
<script>
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected items?") == true) {
				changeActionAndSubmit('admin/logistic-management/jahez/delete');
			} else {
	...
	$(document).ready(function() {
		$("body").on("submit", "#delivery_bulk_form", function(e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo base_url('admin/logistic-management/invoices/jahez/import-file') ?>",
				data: data,
				//dataType: 'json',
				contentType: false,
				cache: false,
	...
	$(document).ready(function() {
		...
		$('#exportForm').on('submit', function(e) {
			...
			let exportUrl = (fileFormat === 'file_format_xlsx') ?
				'admin/logistic-management/invoices/jahez/export-monthly-performance' :
				'admin/logistic-management/invoices/jahez/print-monthly-performance';
