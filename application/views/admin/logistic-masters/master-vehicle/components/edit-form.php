<div class="modal-header">
    <h6 class="modal-title mt-0" id="allotModalFullscreenLabel">Edit Vehicle</h6>
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body px-2" id="allot_body_modal">
    <?php echo form_open("admin/master-vehicle/update", array("id"=>"editVehicleForm", "enctype"=>"multipart/form-data", "class"=>"form-horizontal form-label-left")); ?>
        <input type="hidden" name="id" value="<?= $vehicle_details['id']; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 mb-3 form-group">
                                ...
                                <select name="vehicle_ownership" id="vehicle_ownership" class="form-select">
                                    ...
                                    <option value="Lease" <?= ($vehicle_details['vehicle_ownership'] == 'Lease') ? 'selected' : ''; ?>>Lease</option>
                                    <option value="Owned" <?= ($vehicle_details['vehicle_ownership'] == 'Owned') ? 'selected' : ''; ?>>Owned</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 mb-3 form-group">
                                ...
                                <select class="form-select" id="owner_name_select" name="owner_name_select">
                                    ...
                                    <?php foreach ($sponsors as $sponsor) : ?>
                                        <option value="<?= $sponsor->employer_name ?>" data-cr_no="<?= $sponsor->employer_cr_no; ?>" <?= (!empty($vehicle_details['owner_name_select']) && strcasecmp(trim($vehicle_details['owner_name_select']), trim($sponsor->employer_name)) == 0) ? 'selected' : ''; ?>><?= $sponsor->employer_name ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select name="vehicle_type" id="vehicle_type" class="form-control select2">
                                    ...
                                    <option value="bike" <?= ($vehicle_details['vehicle_type'] == 'bike') ? 'selected' : ''; ?>>Bike</option>
                                    <option value="car" <?= ($vehicle_details['vehicle_type'] == 'car') ? 'selected' : ''; ?>>Car</option>
                                    <option value="van" <?= ($vehicle_details['vehicle_type'] == 'van') ? 'selected' : ''; ?>>Van</option>
                                </select>
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="purchase_date">Vehicle Purchase Date</label>
                                <input type="date" class="form-control" id="purchase_date" name="purchase_date" max="<?php echo date("Y-m-d"); ?>" value="<?= $vehicle_details['purchase_date'] ?>" />
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="vehicle_no">Vehicle Plate Number <span class="text-danger">*</span></label>
                                <input type="text" id="vehicle_no" name="vehicle_no" minlength="6" maxlength="7" class="form-control" value="<?= $vehicle_details['vehicle_no'] ?>">
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="chassis_no">Vehicle chassis Number</label>
                                <input type="text" id="chassis_no" name="chassis_no" maxlength="35" class="form-control" value="<?= $vehicle_details['chassis_no']; ?>">
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="vehicle_expiry">Vehicle Expiry Date <span class="required-field text-danger">*</span></label>
                                <input type="date" class="form-control" id="vehicle_expiry" name="vehicle_expiry" min="<?php echo date("Y-m-d"); ?>" value="<?= $vehicle_details['vehicle_expiry']; ?>" />
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="vehicle_year">Vehicle Year <span class="text-danger">*</span></label>
                                <select name="vehicle_year" id="vehicle_year" class="form-control select2">
                                    ...
                                    <?php 
                                        ...
                                        for ($i = $year_end; $i >= $year_start; $i--) {
                                            $selected = ($vehicle_details['vehicle_year'] == $i) ? 'selected' : '';
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select name="vehicle_model" id="vehicle_model" class="form-control select2">
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select name="vehicle_color" id="vehicle_color" class="form-control select2">
                                    <option value="">Select Vehicle Color</option>
                                    <?php foreach(colorList() as $color){?>
                                    <option value="<?php echo $color->id;?>" <?= ($vehicle_details['vehicle_color'] == $color->id) ? 'selected' : ''; ?>><?php echo $color->color_name;?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select name="vehicle_category" id="vehicle_category" class="form-control select2">
                                    ...
                                    <option value="Staff" <?= ($vehicle_details['vehicle_category'] == 'Staff') ? 'selected' : ''; ?>>Staff</option>
                                    <option value="TGA" <?= ($vehicle_details['vehicle_category'] == 'TGA') ? 'selected' : ''; ?>>TGA</option>
                                    <option value="Route" <?= ($vehicle_details['vehicle_category'] == 'Route') ? 'selected' : ''; ?>>Route</option>
                                </select>
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="sequel_no">Vehicle Sequel Number</label>
                                <input type="text" id="sequel_no" name="sequel_no" maxlength="35" class="form-control" value="<?= $vehicle_details['sequel_no']; ?>">
                            </div>
							
							<div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="custom_card_no">Custom Card No</label>
                                <input type="text" id="custom_card_no" name="custom_card_no" maxlength="30" class="form-control" value="<?php echo $vehicle_details['custom_card_no'];?>">
                            </div>
							...
							<div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select name="city_of_operation" id="city_of_operation" class="form-control select2" required>
                                    ...
                                    <option value="<?php echo $city->id;?>" <?= ($vehicle_details['city_of_operation'] == $city->id) ? 'selected' : ''; ?>><?php echo $city->city_name;?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <input type="checkbox" id="switch4" switch="bool" name="gasoline_chip_status" <?php echo ($vehicle_details['gasoline_chip_status'] == 'on') ? "checked":"" ?> />
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select class="form-select select2" data-parsley-allselected="true" name="insurance_no" id="insurance_no">
                                    ...
                                    <?php foreach(vehiclePolicyList() as $insPolicy) { ?>
                                        <option value="<?php echo $insPolicy->id; ?>" <?php echo ($insPolicy->id == $vehicle_details['insurance_no']) ? ' selected' : '' ?>><?php echo $insPolicy->policy_number; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <select class="form-control" data-parsley-allselected="true" name="insurance_company_name" id="insurance_company_name" readonly style="pointer-events: none;">
                                    ...
                                    <?php foreach(insuCompanyHelper() as $insCompany) { ?>
                                        <option value="<?php echo $insCompany->id; ?>" <?php echo ($insCompany->id == $vehicle_details['insurance_company_name']) ? ' selected' : '' ?>><?php echo $insCompany->company_name; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 form-group">
                                ...
                                <input type="checkbox" id="gps_installed" switch="bool" name="gps_installed" <?php echo ($vehicle_details['gps_installed'] == 'on') ? "checked":"" ?> />
                        ...
                        <div class="row gps-fields">
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <input type="text" id="gps_device_serial" name="gps_device_serial" maxlength="55" value="<?= $vehicle_details['gps_device_serial']; ?>" class="form-control">
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="gps_installation_date">GPS Tracking Installation Date</label>
                                <input type="date" class="form-control" id="gps_installation_date" name="gps_installation_date" value="<?php echo $vehicle_details['gps_installation_date'];?>" max="<?php echo date('Y-m-d');?>" />
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="gps_expiry_date">GPS Tracking Expiry Date</label>
                                <input type="date" class="form-control" id="gps_expiry_date" name="gps_expiry_date" value="<?php echo $vehicle_details['gps_expiry_date'];?>" readonly />
                            </div>

                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="gsp_mobile_no">GPS Mobile No</label>
                                <input type="text" id="gsp_mobile_no" name="gsp_mobile_no" maxlength="15" value="<?php echo $vehicle_details['gsp_mobile_no'];?>" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                ...
                                <input type="text" id="operation_card_no" name="operation_card_no" maxlength="30" class="form-control" value="<?= $vehicle_details['operation_card_no']; ?>">
                            </div>
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="operation_card_issue_date">Operation Card Issue Date</label>
                                <input type="date" class="form-control" id="operation_card_issue_date" name="operation_card_issue_date" value="<?= $vehicle_details['operation_card_issue_date']; ?>" />
                            </div>
                            <div class="col-md-6 col-sm-12 mb-3 form-group">
                                <label for="operation_card_expiry_date">Operation Card Expiry Date</label>
                                <input type="date" class="form-control" id="operation_card_expiry_date" name="operation_card_expiry_date" value="<?= $vehicle_details['operation_card_expiry_date']; ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="file" name="registration_certificate" id="registration_certificate" class="dropify"
                                    data-default-file="<?= !empty($vehicle_details['registration_certificate']) ? base_url($vehicle_details['registration_certificate']) : ''; ?>"
                                    accept=".png, .jpeg, .jpg, .pdf, .doc, .docx">
                                <?php if (!empty($vehicle_details['registration_certificate'])): ?>
                                    <a href="<?= base_url($vehicle_details['registration_certificate']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="col-md-6 mb-3 form-group">
                                ...
                                <input type="file" name="insurance_certificate" id="insurance_certificate" class="dropify"
                                    data-default-file="<?= !empty($vehicle_details['insurance_certificate']) ? base_url($vehicle_details['insurance_certificate']) : ''; ?>"
                                    accept=".png, .jpeg, .jpg, .pdf, .doc, .docx">
                                <?php if (!empty($vehicle_details['insurance_certificate'])): ?>
                                    <a href="<?= base_url($vehicle_details['insurance_certificate']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="col-md-12 mb-3 form-group">
                                ...
                                <input type="file" name="attached_file" id="attached_file" class="dropify"
                                    data-default-file="<?= !empty($vehicle_details['attached_file']) ? base_url($vehicle_details['attached_file']) : ''; ?>"
                                    accept=".png, .jpeg, .jpg, .pdf, .doc, .docx">
                                <?php if (!empty($vehicle_details['attached_file'])): ?>
                                    <a href="<?= base_url($vehicle_details['attached_file']) ?>" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                        View Operation Card
                                    </a>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 mb-3 form-group">
                                ...
                                <select name="status" id="vehicle_status" class="form-select">
                                    ...
                                    <option value="active" <?= ($vehicle_details['status'] == 'active') ? 'selected' : ''; ?>>Active</option>
                                    <option value="inactive" <?= ($vehicle_details['status'] == 'inactive') ? 'selected' : ''; ?>>Inactive</option>
                                    <option value="discontinued" <?= ($vehicle_details['status'] == 'discontinued') ? 'selected' : ''; ?>>Discontinued</option>
                                    <option value="workshop" <?= ($vehicle_details['status'] == 'workshop') ? 'selected' : ''; ?>>Workshop</option>
                                </select>
                            </div>
                                ...
                                <div class="col-md-12 col-sm-12 mb-3 form-group">
                                    ...
                                    <select name="status_reason" id="status_reason" class="form-select">
                                        ...
                                        <?php foreach (masterReasons('vehicle_reason') as $mreason) { ?>
                                            <option value="<?php echo $mreason->id;?>" <?= ($vehicle_details['inactive_reason'] == $mreason->id) ? 'selected' : ''; ?>><?php echo $mreason->reason_title_en;?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col-md-12 col-sm-12 mb-3 form-group">
                                    <label for="status_date">Date <span class="text-danger">*</span></label>
                                    <input type="date" id="status_date" name="status_date" class="form-control" max="<?= date('Y-m-d'); ?>" value="<?= $vehicle_details['status_date']; ?>">
                                </div>
                            </div>
...
<div class="modal-footer">
    <div class="row">
        <div class="col-md-12">
            <button form="editVehicleForm" type="submit" id="submitBtn" class="btn btn-success btn-md">Save</button>
...
<script> 
    ...
    $(document).ready(function () {
        ...
        function updateOwnerOptions() {
			...
			if (ownership === 'Lease') {
				var leaseOwner = 'Theeb Rent a Car';

				// If the Lease option is not already in the dropdown, add it
				if ($ownerSelect.find('option[value="' + leaseOwner + '"]').length === 0) {
					$ownerSelect.empty();
					$ownerSelect.append('<option value="">Select Vehicle Owner</option>');
					$ownerSelect.append('<option value="' + leaseOwner + '">' + leaseOwner + '</option>');
				}

				$ownerSelect.val(leaseOwner); // always select lease owner
				$ownerSelect.prop('disabled', false); // must be enabled to submit
				$ownerSelect.attr('readonly', true);  // fake readonly
				$ownerSelect.css('pointer-events', 'none'); // prevent clicking
				$ownerSelect.css('background-color', '#e9ecef'); // greyed out

			} else if (ownership === 'Owned') {
				// Restore all sponsor options if they were cleared
				if ($ownerSelect.find('option').length <= 1) {
					$ownerSelect.empty();
					$ownerSelect.append('<option value="">Select Vehicle Owner</option>');
					<?php foreach ($sponsors as $sponsor): ?>
						$ownerSelect.append('<option value="<?= $sponsor->employer_name ?>" data-cr_no="<?= $sponsor->employer_cr_no ?>"><?= $sponsor->employer_name ?></option>');
					<?php endforeach; ?>
				}

				// Select the saved owner if exists
				var savedOwner = "<?= trim($vehicle_details['owner_name_select'] ?? '') ?>";
				if (savedOwner) {
					$ownerSelect.val(savedOwner);
				}
		...
		// Trigger on change and page load
    ...
    $(document).ready(function() {
		var vehicle_type = "<?= ($vehicle_details['vehicle_type'] == '') ? 'NULL' : $vehicle_details['vehicle_type']; ?>";
	    selectedVehicleMake(vehicle_type);

		var vehicle_make = "<?= ($vehicle_details['vehicle_make'] == '') ? 'NULL' : $vehicle_details['vehicle_make']; ?>";
	...
	function selectedVehicleMake(vehicle_type){
		var make_id = "<?= ($vehicle_details['vehicle_make'] == '') ? 'NULL' : $vehicle_details['vehicle_make']; ?>";
	...
	function selectedVehicleModel(vehicle_make){
		var vehicle_model = "<?= ($vehicle_details['vehicle_model'] == '') ? 'NULL' : $vehicle_details['vehicle_model']; ?>";
	...
	function getInsuranceDetail(){
		...
		var policy_type = '<?php echo ($vehicle_details['insurance_class'] !== '') ? $vehicle_details['insurance_class'] : 0;?>';
			...
			$.ajax({
				...
				success: function(data) {
					...
					if (data.insurance_type_details && data.insurance_type_details.length > 0) {
                        $.each(data.insurance_type_details, function(index, item) {
                            var isSelected = (policy_type == item.type_id ? 'selected' : '');
                            classSelectContainer += '<option value="'+item.type_id+'" '+isSelected+'>'+item.type_name+'</option>';
                        });
                    }
    ...
    $("#editVehicleForm").on("submit", function (e) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/master-vehicle/update'); ?>",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
