		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Jahez <?= ((isset($summaryData['summary_month'])) ? date('F Y', strtotime($summaryData['summary_month'])) : ''); ?> Summary</h4>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<a class="btn btn-sm btn-custom-white pull-right" title="Back" href="<?php echo base_url('admin/logistic-management/invoices/jahez/list'); ?>"><i class="fa fa-reply"></i> Back</a>
											...
											<tr>
												...
												<?php
													foreach ($visibleTableColumns as $column) {
														...
														// Format dispatch_time if the column is "dispatch_time"
...
$(document).ready(function() {
    ...
    function loadFilteredData(page = 1) {
        ...
        // AJAX Request
        $.ajax({
            url: "<?= base_url('admin/logistic-management/invoices/jahez/detail/' . $summaryData['id']) ?>",
            type: 'GET',
            ...
            success: function(response) {
				...
				if (availableColumns.length) {
					...
					availableColumns.forEach(column => {
						const cleanedHeader = column.replace('mjms.', '').replace('me.', '');
...
function getColumnForm() {
	$.ajax({
		...
		method: 'GET',
		data: { request_type: 'jahez_monthly_summary' },
		success: function(response) {
...
$(document).ready(function() {
    $('#exportForm').on('submit', function(e) {
        ...
        downloadForm.submit().remove();  // Submit and clean up
    });
});
