		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'employment_types', 'delete')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'employment_types', 'add')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Own Store" href="<?php echo base_url('admin/hr/master/employment-types/add') ?>"><i class="fa fa-plus"></i> Add Employment Types</a>
					<?php endif; ?>
				</div>
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url('admin/hr/master/employment-types'); ?>" method="get" id="filter_form">
							<div class="row p-2">
								<div class="col-6 px-1">
									<div class="form-group">
										<label>Search by Employee Types</label>
								...
								<div class="col-md-12 px-1" style="padding-top: 10px;">
									...
									<a href="<?php echo base_url('admin/hr/master/employment-types'); ?>" class="btn btn-custom-danger btn-sm float-end me-2">Clear Filter</a>
								</div>
							</div>
						</form>
					</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			"fixedHeader": true,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/hr/master/employment_types/list?title=<?php echo $this->input->get('title'); ?>&status=<?php echo $this->input->get('status'); ?>",
				type: "POST"
			},
			"columnDefs": [{
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected items?") == true) {
				changeActionAndSubmit('admin/hr/master/employment-types/delete');
			} else {
