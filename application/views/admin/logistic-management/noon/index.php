		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Noon Order Summary</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/noon/list'); ?>">Noon Order Summary</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'noon_daily_performance', 'print_monthly_performance')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'noon_daily_performance', 'import_file')): ?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="bulkImportModalLabel">Noon Order Summary</h5>
				...
				<form id="delivery_bulk_form" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="row px-3">
						<div class="col-md-12 col-sm-12 mb-3 form-group">
							<label for="summary_date">Summary Date<span class="text-danger">*</span></label>
							<div class="position-relative">
						...
						<div class="col-md-12">
							...
							<p style="text-align: center;"><a type="button" href="<?php echo base_url('admin_assets/samples/Noon.xlsx'); ?>" class="btn bt btn-link text-success" target="_blank" download>Download sample file</a></p>
						</div>
...
<div class="modal fade staticBackdrop fixed-left filtersModal" id="filtersModal" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="#filtersModalLabel" style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-dialog-aside">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url('admin/logistic-management/noon/list'); ?>" method="get" id="filter_form">
					<div class="row">
			...
			<div class="modal-footer">
				<a href="<?php echo base_url('admin/logistic-management/noon/list'); ?>" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</a>
...
<script>
	...
	$(document).ready(function() {
		...
		function initializeDataTable() {
			...
			table = $('#summaryTable').DataTable({
				...
				"processing": true,
				"ajax": {
					url: "<?php echo base_url(); ?>admin/logistic-management/noon/ajax-list",
					type: "POST",
					data: function(d) {
	...
	$(document).ready(function() {
		$("body").on("submit", "#delivery_bulk_form", function(e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo base_url('admin/logistic-management/noon/import-file') ?>",
				data: data,
				//dataType: 'json',
				contentType: false,
				cache: false,
	...
	function getColumnForm() {
		$.ajax({
			...
			method: 'GET',
			data: {
				request_type: 'noon_order_summary'
			},
			success: function(response) {
	...
	$(document).ready(function() {
		...
		$('#exportForm').on('submit', function(e) {
			...
			let exportUrl = (fileFormat === 'file_format_xlsx') ?
				'admin/logistic-management/noon/export-daily-summary' :
				'admin/logistic-management/noon/print-order-summary';
