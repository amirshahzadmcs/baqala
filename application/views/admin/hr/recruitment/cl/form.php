		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Contract Letter Master</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/hr/recruitment/cl">Contract Letter List</a></li>
			...
			<div class="col-sm-6">
					<div class="float-end d-sm-block">
						...
						<a class="btn btn-sm btn-custom pull-right" title="Back" href="<?php echo base_url(); ?>admin/hr/recruitment/cl"><i class="fa fa-reply"></i> Back</a>
						<?php }?>
						&nbsp;
 ...
 <!-- end page title -->
  ...
  <div class="container-fluid">
  		<div class="page-content-wrapper">
			<?php echo form_open("admin/hr/recruitment/cl/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
 			 <div class="row">
 			 	<div class="col-12">
 			 		<div class="card">
 			 			<div class="card-body">
							...
							<div class="row">
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<input type="text" class="form-control" id="contract_no" name="contract_no" maxlength="150" value="<?php echo !empty($contract_no) ? $contract_no : $loui_new; ?>" readonly />
									<p class="hint">Contract Number</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<p class="hint">Enter Contract Letter Open Date</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<input type="date" class="form-control" id="dob" name="dob" maxlength="150" value="<?php echo $dob; ?>" required />
									<p class="hint">Enter Date of birth</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="age">Age <span class="required-field">*</span></label>
									<input type="text" class="form-control" id="age" name="age" onKeyPress="return numerics(event);" maxlength="150" value="<?php echo $age; ?>" required />
									<p class="hint">Enter Age</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="city">City <span class="required-field">*</span></label>
									<input type="text" class="form-control" id="city" name="city" maxlength="150" value="<?php echo $city; ?>" required />
									<p class="hint">Enter City</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									<label for="state">State <span class="required-field">*</span></label>
									<input type="text" class="form-control" id="state" name="state" maxlength="150" value="<?php echo $state; ?>" required />
									<p class="hint">Enter State</p>
								</div>
								<div class="col-md-4 col-sm-12 mb-2 form-group">
...
<script type="text/javascript">
	...
	$('#loi').on('change', function(){
		...
		// alert(id);
		$.ajax({
			url: "<?php echo base_url();?>admin/hr/recruitment/cl/getLoiDetail",
			type: "GET",
			data: {"id" : id},
