						...
						<td colspan="3">
							<table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td style="text-align:center;"><?php echo number_format($total_input - $total_output,2);?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="text-align:center;"><strong><?php echo number_format($total_input - $total_output,2);?></strong></td>
								</tr>
							</table>
						</td>
					</tr>
