		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-none d-sm-block">
					<a class="btn btn-sm btn-custom-white pull-right me-1" title="Back" href="<?php echo base_url('admin/assets/category/list');?>"><i class="fa fa-reply"></i> Back</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="card-body">
						<form class="needs-validation" method="POST" action="<?php echo base_url('admin/assets/category/submit');?>" novalidate>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="mb-3">
										<label for="rack_name" class="form-label">Category Name</label>
										<input type="text" class="form-control" id="category_name" value="<?php echo $category_name;?>" placeholder="Category Name" name="category_name" required>
