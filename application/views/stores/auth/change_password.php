    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            <div class="page-content-wrapper">
               <div class="row">
                  <div class="col-3">
						  	<?php $this->load->view('stores/layout/profile-sidebar');?>
                  </div>
                  <div class="col-9">
                     <div class="card">
                        <div class="card-body" style="min-height: 506px;">
                           ...
                           <form method="post" action="<?php echo base_url()?>store/change-password/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
