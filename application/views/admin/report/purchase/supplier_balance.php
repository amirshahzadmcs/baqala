	...
	<div class="page-content-wrapper">
		<div class="row">
			...
			<div class="col-12 mb-3">
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url('admin/report/supplier_balance') ?>" method="get">
							<div class="row">
								...
								<div class="form-group col-lg-2 col-md-4 col-12 mb-3 d-flex align-items-center">
									<!-- <label for="brand">Show Draft Items:</label> -->
									<div class="form-check form-switch" dir="ltr">
										<input type="checkbox" class="form-check-input" id="draft">
										<label class="form-check-label" for="draft">Hide Zero Balance</label>
									</div>
								</div>
								<div class="form-group col-lg-2 col-md-4 col-12 mb-3">
