...
<div class="osahan-order_address">
    <div class="p-3 border-bottom fixed-top" style="background-color:#f0f2f5">
        <div class="d-flex align-items-center">
            ...
            <h5 class="font-weight-bold m-0 ml-3"><?php echo $this->lang->line('msg_sel_address') ?></h5>
	...
	<div class="px-3" style="margin-top:5rem">
		<div class="summary">
			<p class="m-0"><?php echo $this->lang->line('msg_hello') ?>, <strong><?php echo $personal->name;?></strong></p>
		</div>
	</div><!-- End .col-lg-12 -->
    <div class="p-3" id="address_checkout_ajax">
		<?php
		$i = 1;
				...
				<label class="custom-control-label w-100" for="customRadioInline<?php echo $i; ?>">
					<div>
						<div class="p-3 bg-white rounded shadow-sm w-100">
							<div class="d-flex align-items-center ct-rtl mb-2">
							...
							<p class="small text-muted m-0"><?php echo $address->villa_building; ?>, <?php echo $address->complete_address; ?></p>
...
<div class="fixed-bottom">
    <a href="javascript:void(0)" id="proceed_slot" class="btn btn-success btn-lg btn-block"><?php echo $this->lang->line('msg_continue') ?></a>
</div>
<!-- Modal -->
...
$(document).ready(function(e) {
	...
	$("#proceed_slot").on('click', function(){
		...
		if(seladd > 0) {
			...
			alert('<?php echo $this->lang->line('msg_please_select_ship_add'); ?>');
			return false;
		}
	});
	...
	$('#address_form').on('submit', (function(e) {
        ...
        $.ajax({
			...
			function(data){
				...
				show_snack('success','<?php echo $this->lang->line('msg_address_added_success'); ?>')
			},
			error: function(data){
				alert(data);
			}
...
var delete_address = function(u){
	var msg = confirm("<?php echo $this->lang->line('msg_want_to_del_address'); ?>");
    if(msg == true){
        $.ajax({
