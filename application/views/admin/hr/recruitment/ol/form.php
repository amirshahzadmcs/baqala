		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
					<div class="float-end d-sm-block">
						...
						<a class="btn btn-sm btn-custom pull-right" title="Back" href="<?php echo base_url(); ?>admin/hr/recruitment/ol"><i class="fa fa-reply"></i> Back</a>
						<?php }?>
						&nbsp;
 ...
 <!-- end page title -->
  ...
  <div class="container-fluid">
  		<div class="page-content-wrapper">
			<?php echo form_open("admin/hr/recruitment/ol/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
 			 <div class="row">
 			 	<div class="col-12">
 			 		<div class="card">
 			 			<div class="card-body">
							...
							<div class="row">
								<div class="col-md-4 col-sm-12 mb-2 form-group">
									...
									<?php if(isset($ol_id->id)) { $new_id = $ol_id->id; } else { $new_id = 0; } ?>
...
<script type="text/javascript">
	...
	$('#loi').on('change', function(){
		...
		// alert(id);
		$.ajax({
			url: "<?php echo base_url();?>admin/hr/recruitment/ol/getLoiDetail",
			type: "GET",
			data: {"id" : id},
