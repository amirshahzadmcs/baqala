...
/* Disable pointer events and reduce opacity to indicate read-only state */
.readonly-mode input,
...
/* Disable Dropify or custom file inputs */
.readonly-mode .dropify-wrapper {
    pointer-events: none;
    opacity: 0.6;
}

/* Optional: Hide submit buttons or close buttons if needed */
.readonly-mode button[type="submit"],
.readonly-mode .btn-close {
    display: none;
}
</style>
<div class="modal-header">
	<h5 class="modal-title mt-0">Memo Detail</h5>
...
<div class="modal-body px-2">
	<div class="readonly-mode">
        ...
        <div class="row tab-inner-section px-1 py-1 mx-1 description-container">
            ...
            <?php if (!empty($announcement_detail['file_path'])): ?>
                <div class="detail-box my-3">
                    <h5>Attachment</h5>
                    <a href="<?= base_url($announcement_detail['file_path']); ?>" class="btn btn-outline-primary" target="_blank">Download Attachment</a>
                </div>
            <?php endif; ?>
        </div>
        <!-- Notify Via Section -->
