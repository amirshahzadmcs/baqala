...
<?php echo form_open("admin/hr-module/request/save-leave", array("id" => "addLeaveForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
<div class="row tab-inner-section m-1 py-4">
    ...
    <div class="col-md-12 col-sm-12 mb-3 form-group">
        ...
        <select name="leave_types" id="leave_types" class="form-select select2">
            ...
            <?php foreach($leave_lists as $leave_list){ ?>
                <option value="<?php echo $leave_list['id'];?>"><?php echo $leave_list['name'];?></option>
            <?php } ?>
        </select>
    </div>
    <div class="col-md-12 col-sm-12 mb-3 form-group">
