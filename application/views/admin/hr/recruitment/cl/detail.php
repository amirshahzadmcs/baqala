			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Contract Letter's Detail</li>
					</ol>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<a class="btn btn-sm btn-custom-white pull-right" title="Back" href="<?php echo base_url();?>admin/hr/recruitment/cl"><i class="fa fa-reply"></i> Back</a>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<?php $cl_new = date("Ym") . str_pad($new_id + 1, 4, 0, STR_PAD_LEFT);?> 
								<input type="text" class="form-control" id="contract_no" name="contract_no" maxlength="150" value="<?php echo !empty($contract_no) ? $contract_no : $cl_new; ?>" readonly />
