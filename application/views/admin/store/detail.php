				...
				<div class="card">
					<div class="card-body">
						...
						<table id="example" class="table table-bordered">
							<thead>
							<tr><th>Store ID</th><td><?php echo $result->store_id;?></td></tr>
							<tr><th>Display Name (English)</th><td><?php echo $result->store_name;?></td></tr>
							<tr><th>Display Name (Arabic)</th><td><?php echo $result->store_name_arabic;?></td></tr>
							<tr><th>Store Incharge</th><td><?php echo $result->store_incharge;?></td></tr>
							<tr><th>Conatct Number</th><td><?php echo $result->contact_number;?></td></tr>
							<tr><th>Email ID</th><td><?php echo $result->email;?></td></tr>
							<tr><th>Latitude</th><td><?php echo $result->google_coordinates_lat;?></td></tr>
							<tr><th>Longitude</th><td><?php echo $result->google_coordinates_long;?></td></tr>
							<tr><th>Store Complete Address</th><td><?php echo $result->store_location;?></td></tr>
							<tr><th>Store Delivery Radius</th><td><?php echo $result->store_radius;?> KM</td></tr>
