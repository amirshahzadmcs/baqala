	...
	<div class="page-content-wrapper">
		 <div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<?php echo form_open("admin/app/offers/save", array("id"=>"bannerForm", "enctype"=>"multipart/form-data", "class"=>"form-label-left", "data-parsley-validate"=> "")); ?>
						<div class="row">
							<div class="col-md-6 mb-3 form-group">
								<label for="offer_title">Banner Title<span class="text-danger">*</span> (English)</label>
								<input type="text" class="form-control" id="offer_title" name="offer_title" maxlength="255" required />
							</div>

							<div class="col-md-6 mb-3 form-group">
								<label for="offer_title_ar" class="float-end">Banner Title (Arabic)</label>
								<input type="text" class="form-control rtl-input" id="offer_title_ar" name="offer_title_ar" maxlength="255" />
							</div>

							<div class="col-md-6 mb-3 form-group">
								<label for="offer_sub_title">Banner Sub Title<span class="text-danger">*</span> (English)</label>
								<input type="text" class="form-control" id="offer_sub_title" name="offer_sub_title" maxlength="255" required />
							</div>

							<div class="col-md-6 mb-3 form-group">
								<label for="offer_sub_title_ar" class="float-end">Banner Sub Title (Arabic)</label>
								<input type="text" class="form-control rtl-input" id="offer_sub_title_ar" name="offer_sub_title_ar" maxlength="255" />
							</div>

							<div class="col-md-6 mb-3 form-group">
								<label for="coupon_code">Coupon Code<span class="text-danger">*</span></label>
								<input type="text" class="form-control" id="coupon_code" name="coupon_code" maxlength="20" required />
							</div>
							
							<div class="col-md-6 mb-3 form-group">
								<label for="offer_ends_on">Coupon Expiry Date<span class="text-danger">*</span></label>
								<input type="datetime-local" class="form-control" id="offer_ends_on" name="offer_ends_on" required />
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 mb-3 form-group">
