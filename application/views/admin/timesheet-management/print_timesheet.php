                        ...
                        <td colspan="3" style="width: 97%;">
                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="4">
                                <tr>
                                    ...
                                    <td valign="top" bgcolor="#c6efce" style="width: 8%; text-align: center;"><strong>Date</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 7%; text-align: center;"><strong>Emp No</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 24%; text-align: left;"><strong>Employee Name</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 8%; text-align: center;"><strong>Vehicle No</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 12%; text-align: center;"><strong>Platform</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 8%; text-align: center;"><strong>Out Time</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 6%; text-align: center;"><strong>Km</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 5%; text-align: center;"><strong>Batt. (%)</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 8%; text-align: center;"><strong>Working Hours</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 5%; text-align: center;"><strong>Final Delv.</strong></td>
                                    <td valign="top" bgcolor="#c6efce" style="width: 7%; text-align: center;"><strong>OTP Verified</strong></td>
                                </tr>
                                <?php $item_row = 1;
                                foreach ($timesheet as $data) { ?>
                                    <tr>
                                        <td valign="top" style="text-align: center;"><?php echo $item_row; ?></td>
                                        <td valign="top" style="text-align: center;"><?php echo date('d-m-y', strtotime($data->out_time)); ?></td>
                                        <td valign="top" style="text-align: center; <?php echo $data->logs ? 'font-weight: bold:;' : ''; ?>"><?php echo $data->emp_no; ?></td>
