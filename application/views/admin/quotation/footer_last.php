	...
	<tr>
		...
		<td colspan="3" style="border-top:2px solid #e0b500;border-bottom:2px solid #e0b500;width: 90%;">
			<table cellpadding="2" style="width: 100%; margin-top: 0px; padding: 2px; border-top: none;font-size:13px;">
				...
				<tr>
					<td colspan="5" style="text-align: left;font-size:11px;">Delivery Instructions: <?php echo $result['order']['shipping_instruction']; ?></td>
					<td colspan="1" style="text-align: right;border-top:1px solid #2fa55d;"><strong>Sub Total</strong></td>
					<td colspan="1" style="text-align: right;border-top:1px solid #2fa55d;">SAR <?php echo sprintf("%.2f",$amt_exl_vat); ?></td>
				</tr>
				<tr>
					<td colspan="5" style="text-align: left;line-height:0px;font-size:11px;">Contact Person: <?php echo $result['order']['s_person_name']; ?></td>
					<td colspan="1" style="text-align: right;line-height:8px;font-size:10px;">(excl. VAT)</td>
					<td colspan="1" style="text-align: right;"></td>
				</tr>
				<tr>
					<td colspan="5" style="text-align: left;line-height:-10px;font-size:11px;">Mobile No: <?php echo $result['order']['s_mobile']; ?></td>
					<td colspan="1" style="text-align: right;line-height:28px;background-color:#f8f8f8;border-bottom:1px solid #2fa55d;"><strong>VAT (15%)</strong></td>
					<td colspan="1" style="text-align: right;line-height:28px;background-color:#f8f8f8;border-bottom:1px solid #2fa55d;">SAR <?php echo sprintf("%.2f",$total_vat); ?></td>
				</tr>
				<tr><td colspan="5"></td><td colspan="2" style="line-height:0px;"></td></tr>
				<tr>
					<td colspan="5" style="text-align: right;"></td>
					<td colspan="1" style="text-align: right;line-height:-10px;"><strong>TOTAL</strong></td>
					<td colspan="1" style="text-align: right;line-height:-10px;"><b>SAR <?php $net_amt = $result['order']['order_total']; echo sprintf("%.2f",$net_amt);?></b></td>
				</tr>
			</table>
		</td>
		<td style="width: 5%;"></td>
