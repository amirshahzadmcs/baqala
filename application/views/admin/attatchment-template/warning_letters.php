                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">This letter serves as a formal <?= $request_type;?> regarding your recent conduct. Please find the detailed <?= $request_type;?> letter attached for your reference.</p>
                            </td>
                        </tr>
                    </table>
                </td>
