				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'main_id', 'emp_id', 'emp_no', 'full_name', 'rider_id', 'contract_name', 'completed_orders', 'basic_payment', 'acceptance_rate_penalties', 'contact_rate_penalties', 'stacking_deduction', 'declined_penalties_day_logic', 'google_capped_after', 'rider_scoring', 'rider_basic', 'monthly_balance', 'created_at', 'updated_at'
                        ];
                    ?>
