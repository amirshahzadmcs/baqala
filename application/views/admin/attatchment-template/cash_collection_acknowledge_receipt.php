                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">We acknowledge the receipt of cash against EMP ID <?= $emp_no;?> as per the below information.</p>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Date: <?= $date_of_collection ? date('d-m-Y', strtotime($date_of_collection)) : '';?></p>
                                <p style="line-height: 15px;">Today's Collection Amount: <?= $collection_amount;?></p>
                                <p style="line-height: 15px;">Today's Submitted Amount: <?= $submitted_amount;?></p>
                                <p style="line-height: 15px;">Today's Collection Balance: <?= $collection_balance;?></p>
                                <p style="line-height: 15px;">Reason: <?= $reason;?></p>
                            </td>
                        </tr>
                    </table>
                </td>
