		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'branches', 'delete')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'branches', 'add')): ?>
						&nbsp;
						<a class="btn btn-custom-success btn-sm pull-right me-1" title="Add Branch" href="<?php echo base_url('admin/hr/master/branch/add') ?>"><i class="fa fa-plus"></i> Add Branch</a>
					<?php endif; ?>
				</div>
	...
	<div class="page-content-wrapper">
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<form action="<?php echo base_url('admin/hr/master/branch'); ?>" method="get" id="filter_form">
							<div class="row p-2">
								...
								<div class="col-md-12 px-1" style="padding-top: 10px;">
									...
									<a href="<?php echo base_url('admin/hr/master/branch'); ?>" class="btn btn-custom-danger btn-sm float-end me-2">Clear Filter</a>
								</div>
							</div>
						</form>
					</div>
...
<script>
	$(document).ready(function() {
		$('#store-table').dataTable({
			...
			searching: false,
			"ajax": {
				url: "<?php echo base_url(); ?>admin/hr/master/branch/get_list?title=<?php echo $this->input->get('title'); ?>&status=<?php echo $this->input->get('status'); ?>",
				type: "POST"
			},
			"columnDefs": [{
	...
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected branch?") == true) {
				changeActionAndSubmit('admin/hr/master/branch/delete');
			} else {
