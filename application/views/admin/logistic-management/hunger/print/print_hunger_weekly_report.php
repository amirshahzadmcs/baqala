...
<html lang="ae">
	<head>
		...
		<title>Maha Al Fala - Weekly Performance Report</title>
		<style>
				...
				<td>
					<table class="table" width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size: 12px;">
						<tr>
							...
							<td colspan="4" valign="middle" style="text-align:right;color:#000;">Hunger Station - Weekly Delivery Report - <?php echo $data_range;?></td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					<table class="table" width="100%" border="1" cellspacing="0" cellpadding="3">
						<tr>
							...
							<th width="60px" align="center" style="background-color: #ddd;color:#000">Hunger ID</th>
						...
						<?php if(!empty($weekly_report)) { ?>
							...
							<tr>
								...
								<td align="center"><?php echo $row['Hunger ID']; ?></td>
