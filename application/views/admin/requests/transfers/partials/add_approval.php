...
<?php echo form_open("admin/hr-module/request/transfer/save", array("id" => "addTransferForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#employeeSelectionButton').on('click', function() {
			$.ajax({
				url: '<?php echo base_url('admin/hr-module/request/transfer/get-employee-list'); ?>',
				method: 'GET',
