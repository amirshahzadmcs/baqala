...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="padding:15px 0px; font-size:24px; font-weight:bold; color:#666666;">ORDER CANCELED</td>
  </tr>
  <tr>
...
Your Order has been canceled. Cancel order details are:</td>
  </tr>
  ...
  <tr>
    <td style="padding:15px 0px; font-size:16px; line-height:25px;">
  ...
  <tr>
    <td style="padding:15px 0px 5px 0px; font-size:14px; font-weight:bold;">For our Latest Modernized Collection, follow us -</td>
  </tr>
  <tr>
    <td>
