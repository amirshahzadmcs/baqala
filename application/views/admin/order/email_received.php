...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td style="padding:15px 0px; font-size:24px; font-weight:bold; color:#666666;">ORDER RECEIVED</td>
  </tr>
  <tr>
...
Thank you for Shopping with Baqala Station, your order has been received and your Order details are shown below for your reference :</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="padding:15px 0px; font-size:16px; line-height:25px;">NOTE : We will update you with order confirmation, once the order will be confirmed from Baqala Station<br />
      For more visit your <a href="https://www.baqalastation.com/" style="color:#38C2EB; text-decoration:none;"><strong>Baqala Station</strong></a></td>
  </tr>
  <tr>
    <td style="background:#000; height:2px"></td>
  </tr>
 ...
 <tr>
    <td style="background:#F1F1F1; padding:10px; text-align:center; font-size:16px;">Call on +91 - +966 59 393 5577 &nbsp; | &nbsp; info@baqalastation.com &nbsp; | &nbsp; www.baqalastation.com</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
