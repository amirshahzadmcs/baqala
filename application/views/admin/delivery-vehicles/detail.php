				...
				<div class="float-end d-sm-block">
					...
					<div class="btn-group me-2">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="<?php echo base_url('admin/Deliveryvehicle/print_agreement?id='. $id);?>" target="_blank"> Rider Agreement</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url('admin/Deliveryvehicle/print_contract?id='. $id);?>" target="_blank"> Employment Contract</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url('admin/Deliveryvehicle/print_note?id='. $id);?>" target="_blank"> Promissory Note</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url('admin/Deliveryvehicle/print_job_letter?id='. $id);?>" target="_blank"> Offer Letter</a>
						</div>
					</div>
					<a class="btn btn-custom-white btn-sm pull-right" title="Add" href="<?php echo base_url('admin/deliveryvehicle')?>"><i class="fa fa-reply"></i> Back</a>
					<?php } ?>
				</div>
								...
								<div class="tab-pane active" id="profileTab" role="tabpanel">
									...
									<div class="row size-inner-section p-2">
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											...
											<select name="rider_type" class="form-control" required>
								...
								<div class="tab-pane" id="documentsTab" role="tabpanel">
									<div class="row size-inner-section p-2">
										...
										<div class="col-md-3 col-sm-12 mb-3 form-group">
											<div class="upload-div">
												<label class="font-size-11" style="margin-bottom: 20px;">Profile Picture (white background) <span class="text-danger">*</span></label>
										...
										<div class="col-md-3 col-sm-12 mb-3 form-group">
											<div class="upload-div">
												<!-- File upload form -->
												<label class="font-size-11" style="margin-bottom: 20px;">Iqama Image Front <span class="text-danger">*</span></label>
										...
										<div class="col-md-3 col-sm-12 mb-3 form-group">
											<div class="upload-div">
												<!-- File upload form -->
												<label class="font-size-11" style="margin-bottom: 20px;">Driving Licence Front <span class="text-danger">*</span></label>
										...
										<div class="col-md-3 col-sm-12 mb-3 form-group">
											<div class="upload-div">
												<!-- File upload form -->
												<label class="mb-2 font-size-11">IBAN Certificate (Account name and bank name must be clear) <span class="text-danger">*</span></label>
									...
									<div class="row size-inner-section p-2">
										...
										<div class="col-md-3 col-sm-12 mb-3 form-group">
											<div class="upload-div">
												<!-- File upload form -->
												<label class="mb-2 font-size-11"><span class="vehicle-type">Car</span> Registration Front (Serial no. must be clear) <span class="text-danger">*</span></label>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form method="post" action="admin/deliveryvehicle/change_password" id="password_form" data-parsley-validate="" class="form-horizontal">
...
<script>
	...
	$('.password-show').click(function() {
		...
		$.ajax({
			type: "post",
			url: "<?php echo base_url();?>admin/deliveryvehicle/getLoginDetail",
	...
	$('#password_form').on('submit', (function(e) {
		...
		e.preventDefault();
		$.ajax({
			url: '<?php echo base_url();?>admin/deliveryvehicle/change_password',
			type: "POST",
