<div>
	<?php echo form_open("admin/hr/employees/add-contract", array("id" => "contract_form", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-12 mb-3 form-group">
				...
				<input type="date" class="form-control" id="contract_start_date" name="contract_start_date" value="<?php echo date('Y-m-d');?>" required />
			</div>
			<div class="col-md-6 col-sm-12 mb-3 form-group">
				<label for="start_date_hijri">Start Date (Hijri)</label>
				<input type="date" class="form-control" id="start_date_hijri" name="start_date_hijri" value="<?php echo Greg2Hijri(date('Y-m-d'));?>" readonly />
			</div>
			<div class="col-md-6 col-sm-12 mb-3 form-group">
				<label for="contract_end_date">End Date (Gregorian)</label>
				<input type="date" class="form-control" id="contract_end_date" name="contract_end_date" value="" readonly />
			</div>
			<div class="col-md-6 col-sm-12 mb-3 form-group">
				<label for="end_date_hijri">End Date (Hijri)</label>
				<input type="date" class="form-control" id="end_date_hijri" name="end_date_hijri" value="" readonly />
			</div>
			<div class="col-md-12 col-sm-12 mb-3 form-group">
				<label for="is_probation_period">Did the Employee have a Probation Period?</label>
				<div>
					<input class="form-check-input" type="radio" id="is_probation_period1" value="yes" name="is_probation_period" style="vertical-align: top;margin-right: 3px;">
					<label class="form-check-label" for="is_probation_period1">
					Yes
					</label>
					<input class="form-check-input ms-3" type="radio" id="is_probation_period2" value="no" name="is_probation_period" style="vertical-align: top;margin-right: 3px;">
					<label class="form-check-label" for="is_probation_period2">
					No
					</label>
				</div>
			</div>
			<div class="col-md-6 col-sm-12 mb-3 form-group probation_period d-none">
				<label for="probation_days">Probation Period (Number of days)</label>
				<input type="text" class="form-control" id="probation_days" name="probation_days" value="" />
			</div>
			<div class="col-md-6 col-sm-12 mb-3 form-group">
				...
				<select class="form-control form-select" data-parsley-allselected="true" name="contract_status" id="contract_status" required>
					...
					<?php foreach(contractStatusHelper() as $cstatus) { ?>
						<option value="<?php echo $cstatus->id; ?>"><?php echo $cstatus->status_type; ?></option>
					<?php } ?>
				</select>
			</div>
			<div class="col-md-12 col-sm-12 mb-3 form-group">
