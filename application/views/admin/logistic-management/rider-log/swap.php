		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Aggregator Allotment / Unallotment Log</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/rider/list'); ?>">Riders Log</a></li>
						<li class="breadcrumb-item active">Allotment / Unallotment Log</li>
					</ol>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo base_url('admin/logistic-management/rider/allot-unallot-log'); ?>" method="get" id="filter_form">
							<div class="row">
							...
							<div class="row mt-2">
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									...
									<a href="<?php echo base_url('admin/logistic-management/rider/allot-unallot-log'); ?>" class="btn btn-danger btn-md float-end">Reset Filter</a>
								</div>
							</div>
						</form>
					</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						<table id="swapTable" class="table table-bordered jambo_table bulk_action" style="width:100%">
							<thead>
								<tr>
									<th>S.No.</th>
									<th>Emp No.</th>
...
$(document).ready(function() {
    $('#swapTable').dataTable({
        ...
        "searching": false,
        "ajax": {
            url: "<?php echo base_url();?>admin/logistic-management/rider/swap-ajax-list?keyword=<?php echo $this->input->get('keyword')?>&id_type=<?php echo $this->input->get('id_type')?>&platform=<?php echo $this->input->get('platform')?>&id_number=<?php echo $this->input->get('id_number')?>&from=<?php echo $this->input->get('from')?>&to=<?php echo $this->input->get('to')?>",
            type: "POST"
        },
        "columnDefs": [
            {
