<table border="0" cellspacing="0" cellpadding="1" style="font-size: 10px; width: 100%;">
	...
	<tr>
		...
		<td align="left" valign="center" style="width: 50%;border-bottom: 1px solid #000;line-height:1.5;">
			<p></p>
			<strong style="font-size: 14px;">Sim Card Database - Prepaid Mobile Bills Summary</strong><br>
			<strong style="font-size: 12px;">Date From: - <?php echo ($this->input->get('period_start') !== '') ? date('d M Y', strtotime($start)) : 'NA'; ?> To <?php echo ($this->input->get('period_end')) ? date('d M Y', strtotime($end)) : 'NA'; ?></strong><br>
			<span>Filter: <?php echo ($this->input->get('user') == '') ? 'All Data Available' : employeeDetailHelper($this->input->get('user'))->full_name; ?></span><br>
