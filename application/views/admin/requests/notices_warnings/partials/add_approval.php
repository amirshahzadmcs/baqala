...
<?php echo form_open("admin/hr-module/request/notice-warning/save", array("id" => "addNoticesForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#employeeSelectionButton').on('click', function() {
			$.ajax({
				url: '<?php echo base_url('admin/hr-module/request/notice-warning/get-employee-list'); ?>',
				method: 'GET',
		...
		$('#addNoticesForm').on('submit', function (e) {
			e.preventDefault();
