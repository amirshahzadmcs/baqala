		<footer class="footer">
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="text-sm-end d-none d-sm-block">Developed with <i class="mdi mdi-heart text-danger"></i> by IXIANA TECH</div>
					</div>
				</div>
			</div>
		</footer>
	...
	<!-- JAVASCRIPT -->
        ...
        <!-- Magnific Popup-->
        <script src="<?php echo base_url('store_assets/libs/magnific-popup/jquery.magnific-popup.min.js');?>"></script>
        <!-- Tour init js-->
        <script src="<?php echo base_url('store_assets/js/pages/lightbox.init.js');?>"></script>
        <!--  select2  -->
