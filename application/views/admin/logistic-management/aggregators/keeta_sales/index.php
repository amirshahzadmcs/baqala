		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Keeta Sales Data</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/invoices/keeta-sales/list'); ?>">Keeta Sales Data</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'keeta_sales_data', 'delete')): ?>
					...
					<?php endif;
					if (check_action_permission(get_user_role(), 'keeta_sales_data', 'import_file')): ?>
						...
						<table id="employeeTable" class="table table-bordered jambo_table" style="width:100%">
							<thead>
								<tr>
									...
									<th class="text-center">Order Based Pricing</th>
									<th class="text-center">Payble Amount</th>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<td align="center"><?= $summary['Delivered_Orders']; ?></td>
											<td align="center"><?= $summary['Order_Based_Pricing']; ?></td>
											...
											<td align="center">
												<div class="btn-group ms-2">
													...
													<div class="dropdown-menu dropdown-menu-end">
														<?php if (check_action_permission(get_user_role(), 'keeta_sales_data', 'detail')): ?>
															<a class="dropdown-item" href="<?= base_url('admin/logistic-management/invoices/keeta-sales/detail/' . $summary['id']); ?>">
																<i class="mdi mdi-stretch-to-page-outline me-2"></i> Detail
															</a>
															<div class="dropdown-divider"></div>
														<?php endif;
														if (check_action_permission(get_user_role(), 'keeta_sales_data', 'print_export_data')): ?>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title px-3" id="bulkImportModalLabel">Keeta Sales Data</h5>
				...
				<form id="delivery_bulk_form" method="post" enctype="multipart/form-data" autocomplete="off">
					<div class="row px-3">
						...
						<div class="col-md-12">
							...
							<p style="text-align: center;"><a type="button" href="<?php echo base_url('admin_assets/samples/Keeta-Sales-Data.xlsx'); ?>" class="btn bt btn-link text-success" target="_blank" download>Download sample file</a></p>
						</div>
...
<script>
	function deleteAction() {
		...
		if (inputCount > 0) {
			if (confirm("Do you want to delete selected items?") == true) {
				changeActionAndSubmit('admin/logistic-management/invoices/keeta-sales/delete');
			} else {
	...
	$(document).ready(function() {
		$("body").on("submit", "#delivery_bulk_form", function(e) {
			...
			$.ajax({
				type: 'POST',
				url: "<?php echo base_url('admin/logistic-management/invoices/keeta-sales/import-file') ?>",
				data: data,
				//dataType: 'json',
				contentType: false,
				cache: false,
	...
	$(document).ready(function() {
		...
		$('#exportForm').on('submit', function(e) {
			...
			let exportUrl = (fileFormat === 'file_format_xlsx') ?
				'admin/logistic-management/invoices/keeta-sales/export-monthly-sales' :
				'admin/logistic-management/invoices/keeta-sales/print-monthly-sales';
