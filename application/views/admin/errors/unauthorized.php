								...
								<div class="card-body">
									<div class="px-2 py-3">
										...
										<div class="text-center p-3">
											<h1 class="error-page mt-5" style="font-size: 36px;"><span>Page Expired!</span></h1>
											<h4 class="mb-4 mt-5">Sorry, your session is expired</h4>
											<p class="mb-4 mx-auto">Please click below button to login again and to start using admin panel. </p>
											<a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url('admin/login');?>"><i class="mdi mdi-home"></i> Back to Login</a>
										</div>
