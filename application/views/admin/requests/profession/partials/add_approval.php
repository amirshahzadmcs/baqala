...
<?php echo form_open("admin/hr-module/request/change-profession/save", array("id" => "addProfessionForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
