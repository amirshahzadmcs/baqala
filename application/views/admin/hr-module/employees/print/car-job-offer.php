...
<body>
	...
	<table border="1" cellspacing="0" cellpadding="3" style="width: 100%;font-size: 9px;">
		...
		<tr>
			<td colspan="2" align="left">
				We are pleased to offer you an appointment in our organization as Delivery Associate - Car, you will be based in our Riyadh office.
			</td>
	...
	<table border="1" cellspacing="0" cellpadding="3" style="width: 100%;font-size: 9px;">
		<tr style="background-color:#000000;color:#ffffff;">
			...
			<td align="left">Delivery Associate - Car</td>
		...
		<tr>
            ...
            <td align="left">2 Years (Transfer not Allowed)</td>
            <td align="right">سنتان (لايوجد نقل كفالة)</td>
            <td align="right">مدة العقد</td>
        </tr>
	</table>
	...
	<table border="1" cellspacing="0" cellpadding="3" style="width: 100%;font-size: 9px;">
		...
		<tr>
			<td align="right">0-400 Delivery</td>
			<td align="center">SAR 4/-</td>
			<td align="center">SAR 1,600/-</td>
			<td align="right">توصيل 0-400</td>
		</tr>
		<tr>
			<td align="right">401-500 Delivery</td>
			<td align="center">SAR 7/-</td>
			<td align="center">SAR 700/-</td>
			<td align="right">توصيل 500-401</td>
		</tr>
		<tr>
			<td align="right">501-600 Delivery</td>
			<td align="center">SAR 8/-</td>
			<td align="center">SAR 800/-</td>
			<td align="right">توصيل 600-501</td>
		</tr>
		<tr>
			<td align="right">601+ Delivery</td>
			<td align="center">SAR 9/-</td>
			<td align="center">SAR /-</td>
			<td align="right">توصيل 600+</td>
		</tr>
		<tr>
			<td align="right">Bonus of 600 Delivery</td>
			<td align="center">SAR 200/-</td>
			<td align="center">SAR 200/-</td>
			<td align="right">مكافئة توصيل 600</td>
		</tr>
		<tr>
			<td align="center" colspan="2" style="color:red">Total on 600 Completed Delivery</td>
			<td align="center" style="color:red">Up to 3,300/-</td>
			<td align="right" style="color:red">الإجمالي على 600 توصيل مكتملة</td>
		</tr>
		<tr>
