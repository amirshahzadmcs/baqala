				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'main_id', 'emp_id', 'emp_no', 'full_name', 'partner_id', 'partner_name', 'billing_cycle', 'courier_id', 'courier_name', 'is_valid', 'reason', 'online_days_valid', 'daily_online_hours_valid', 'daily_online_hours_peak_valid', 'delivered_orders', 'order_based_pricing', 'valid_da_capacity_incentives', 'on_time_incentives', 'subsidy', 'activities_rewards', 'deduction', 'food_compensation', 'other_adjustment', 'tips_vat_excluded', 'tga_deduction_vat_excluded', 'total_payable_amount', 'created_at', 'updated_at'
                        ];
                    ?>
