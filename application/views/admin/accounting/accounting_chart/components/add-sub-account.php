		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="mb-3 loader-input">
					...
					<input type="text" class="form-control" id="code" name="code" onblur="checkDuplicateCode()" value="<?php echo $default_code; ?>" required="">
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 mb-3">
				...
				<select name="main_account" id="main_account" class="form-select select2" required>
					<option value="<?php echo $parent_detail['branch_id']; ?>"><?php echo $parent_detail['branch_name']; ?></option>
				</select>
			</div>
		</div>
		<div class="row">
...
<script>
	...
	$(document).ready(function() {
		$('#addAccountForm').on('input change', function() {
			$('#addAccountBtn').prop("disabled", false);
		});
	})
</script>
