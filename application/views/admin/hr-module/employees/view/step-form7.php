					...
					<div class="card-body">
						...
						<div class="row size-inner-section px-2 py-4 mx-2">
							...
							<div class="text-center m-auto">
								...
								<?php if(check_action_permission('employees', 'view_employees', 'save_transaction_request')):?>
						...
						<div class="twitter-bs-wizard">
							<ul class="pager wizard twitter-bs-wizard-pager-link">
								<li class="previous"><a href="<?php echo ($emp_detail->id > 0) ? base_url('admin/hr/employees/view/step-6/'.$emp_detail->id) : base_url('admin/hr/employees'); ?>" class="btn btn-custom-secondary"><i class="mdi mdi-arrow-left me-1"></i> Prevoius </a></li>
								<li class="next"><a type="button" href="<?php echo ($emp_detail->id > 0) ? base_url('admin/hr/employees/view/step-8/'.$emp_detail->id) : base_url('admin/hr/employees'); ?>" class="btn btn-custom-success"> Next Step <i class="mdi mdi-arrow-right ms-1"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
