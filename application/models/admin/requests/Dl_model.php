...
class Dl_model extends CI_Model{
	...
	function make_query() {
		$sql = "SELECT la.*, lt.name AS leave_type_name FROM request_approval la LEFT JOIN leave_types lt ON JSON_EXTRACT(la.approval_detail, '$.leave_types') = CAST(lt.id AS CHAR) WHERE la.approval_types = 'DlRequest'";
		return $sql;
	}
	...
	public function get_all_employees() {
		// Check if any DlRequest has `is_applicable_to_all = yes`
