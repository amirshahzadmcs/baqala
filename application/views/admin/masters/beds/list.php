        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <div class="float-end d-sm-block">
                    <?php if(check_action_permission(get_user_role(), 'beds', 'delete')):?>
                    ...
                    <?php endif; if(check_action_permission(get_user_role(), 'beds', 'add')):?>
                    <a class="btn btn-custom-success btn-sm pull-right" title="Add" href="<?php echo base_url('admin/master/beds/add') ?>"><i class="fa fa-plus"></i> Add Beds</a>
                    <?php endif; ?>
    ...
    <div class="page-content-wrapper">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo form_open('admin/master/beds/delete', array("id" => "delete_form")); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('#itemTable').dataTable({
            ...
            "order": [],
            "ajax": {
                url: "<?php echo base_url(); ?>admin/master/beds/get-list",
                type: "POST",
