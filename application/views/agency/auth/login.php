        ...
        <div class="main-container">
			<div class="login100-form">
				...
				<div class="form-container" id="signup-form">
					...
					<form class="validate-form" method="POST" action="<?= base_url('hiring-agency/login-submit');?>">
						<div class="pt-5">
			...
			<div class="login100-more" style="background-image: url('images/hiring-agency.avif');"></div>
        </div>
        <!-- /container -->
