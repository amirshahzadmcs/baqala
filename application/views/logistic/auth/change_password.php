                    ...
                    <div class="col-sm-6">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?= base_url('logistic-partner');?>">Dashboard</a>
                                </li>
                    ...
                    <div class="col-sm-6">
                        <div class="float-end d-none d-sm-block">
                            <a class="btn btn-sm btn-custom-white pull-right me-1" title="Back"
                                href="<?php echo base_url('logistic-partner');?>"><i class="fa fa-reply"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="page-content-wrapper">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <?php $this->load->view('logistic/layout/profile-sidebar');?>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="card p-3">
                            <div class="card-body" style="min-height: 506px;">
                                ...
                                <form method="post" action="<?php echo base_url('logistic-partner/update-password')?>"
