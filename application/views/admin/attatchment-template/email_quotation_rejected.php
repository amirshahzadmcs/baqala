...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Quotation Rejected | Baqala Station</title>
        <style type="text/css">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px">Your quotation with quotation number #<?php echo $result['order']['invoice_prefix'] .'-'. $result['order']['quotation_no'];?> has been rejected. For more information please contact to us.</p>
                            </td>
                        </tr>
