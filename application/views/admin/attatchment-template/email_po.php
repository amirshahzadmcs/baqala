...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Purchase Order | Baqala Station</title>
        <style type="text/css">
                        ...
                        <tr>
                            <td align="center" valign="top" style="padding: 36px 24px 0px;">
                                <a href="#" target="_blank" style="display: inline-block;">
                                    <img src="<?php echo base_url();?>images/logo.png" alt="Logo" border="0" style="display: block; width: 65%; max-width: 80%;" />
                                </a>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" style="padding: 36px 0px 5px;">
                                <h4 style="margin: 0; font-size: 16px; font-weight: 600; letter-spacing: 0px; line-height: 14px; color: #181818;">Dear, <?php echo $order->vendor_name;?>,</h4>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">This is informed you that, your offer (Ref #<?php echo 'PO-'. $order->id;?>) dated <?php echo date("d-m-Y", strtotime($order->po_date)); ?>, has been approved.</p>
                                <p style="line-height: 30px">Please note that the attached PO details and under the mentioned terms are binding and have been decisive in approving you offer.</p>
                            </td>
                        </tr>
