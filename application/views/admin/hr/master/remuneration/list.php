		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/hr/master/insurance-type/list'); ?>">Master Remuneration</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-none d-sm-block">
					<?php if (check_action_permission(get_user_role(), 'remunerations', 'delete')): ?>
...
<div class="container-fluid">
	<div class="page-content-wrapper">
		<div class="row">
			<?php if (check_action_permission(get_user_role(), 'remunerations', 'add')): ?>
				<div class="col-4">
					<div class="card">
						<div class="card-body">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="remuneration_name" name="remuneration_name" required>
											<div class="invalid-feedback">
												Please provide a remuneration name.
											</div>
										</div>
									</div>
									<div class="col-md-12">
										<div class="mb-3">
											...
											<input type="text" class="form-control rtl-input" id="remuneration_name_ar" name="remuneration_name_ar" required>
											<div class="invalid-feedback">
			...
			<?php endif; ?>
			<div class="<?php echo check_action_permission(get_user_role(), 'remunerations', 'add') ? 'col-8' : 'col-12'; ?>">
				<div class="card">
					<div class="card-body">
						<div>
						...
						<?php echo form_open('admin/hr/master/remuneration/delete', array("id" => "delete_form")); ?>
...
<script>
	$(document).ready(function() {
		$('#datatable-rack').dataTable({
			...
			"order": [],
			"ajax": {
				url: "<?php echo base_url(); ?>admin/hr/master/remuneration/ajax-list",
				type: "POST"
			},
			"columnDefs": [{
				"targets": [0, 1, 2, 3, 4, 5],
