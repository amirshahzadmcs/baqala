...
<head>
	...
	<title>Baqala Station - Stock Transfer Request</title>
	<style>
			...
			<td colspan="3">
				<table width="100%" border="1" cellspacing="0" cellpadding="5">
					<tr>
						...
						<td valign="top" bgcolor="#CCCCCC" style="width: 10%;"><strong>SIZE</strong></td>
					...
					<tr>
						...
						<td valign="top"><?php echo strtoupper($product->parent_sku) .'-'. strtoupper($product->item_sku);?></td>
						<td valign="top"><?php echo $product->barcode;?></td>
						<td valign="top">
							<?php echo $product->item_description; ?>
						</td>
						<td valign="top"><?php echo strtoupper($product->size);?></td>
						...
						<td valign="top" style="text-align: right;"><?php echo $product->amt_excl_vat;?></td>
						<td valign="top" align="right"><?php echo $product->vat_amt;?></td>
						...
						<tr>
							...
							<td style="vertical-align: top; width: 40.5%;">
								<table border="1" cellspacing="0" cellpadding="5" style="font-size: 10px; width: 100%;border-top:none;">
									<tr>
										<td colspan="2" style="text-align: right;">TOTAL UNIT</td>
										<td style="text-align:right" class="amount subtotal"><?php echo $order->total_qty;?></td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: right;">SUBTOTAL</td>
										<td style="text-align:right" class="amount subtotal"><?php echo $order->total_amt_excl_vat;?></td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: right;">VAT %</td>
										<td style="text-align:right" class="amount">15</td>
									</tr>
									<tr>
										<td colspan="2" style="text-align: right;">VAT AMOUNT</td>
										<td style="text-align:right" class="amount"><?php echo $order->vat_amt;?></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="total amount" align="right"><?php echo $order->total_tax_inclusive;?></td>
									</tr>
								</table>
							</td>
						</tr>
