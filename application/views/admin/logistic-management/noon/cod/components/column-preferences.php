				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'emp_id', 'emp_no', 'full_name', 'ops_date', 'id_user', 'user_type', 'vendor_code', 'vendor_name', 'order_cash_collected', 'cash_deposited', 'balance_total', 'final_balance_closing', 'created_at', 'updated_at'
                        ];
                    ?>
