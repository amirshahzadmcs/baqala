                ...
                <div class="row align-items-center">
					...
					<div class="col-sm-6">
						<div class="float-end d-none d-sm-block">
							...
							<button class="btn btn-danger btn-sm pull-right" onclick="confirm('Really want to delete this rack?') ? $('#delete_form').submit() : false;" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></button>
						</div>
					</div>
                </div>
            </div>
            ...
            <div class="page-content-wrapper">
				<div class="row">
					<div class="col-4">
						<div class="card">
							<div class="card-body">
								<form class="needs-validation" method="POST" action="<?php echo base_url('store/rack/submit');?>" novalidate>
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
					...
					<div class="col-8">
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open('store/rack/delete', array("id"=>"delete_form"));?>
...
$(document).ready(function() {
	$('#datatable-rack').dataTable({
		...
		"order":[],
		"ajax":{
			url:"<?php echo base_url();?>store/rack/get_list",
			type:"POST"
		},
		"columnDefs":[
			{
