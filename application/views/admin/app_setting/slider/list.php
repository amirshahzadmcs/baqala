		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<a href="<?php echo base_url('admin/app/banner/add');?>" type="button" class="btn btn-custom-success btn-sm pull-right" title="Add"><i class="fa fa-plus"></i> Add New Banner</a>
					<?php } ?>
				</div>
 	...
 	<div class="page-content-wrapper">
 		<div class="row">
 			<div class="col-12">
 				<div class="card">
 					<div class="card-body">
						<?php echo form_open("admin/app/banner/delete", array("id"=>"delete_form"));?>
		 					<table id="bannerTable" class="table table-striped table-bordered jambo_table bulk_action" style="width:100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo '<a class="btn btn-outline-secondary btn-custom-light btn-sm edit" data-toggle="tooltip" title="Edit" href="'.base_url().'admin/app/banner/edit?id='.$item->id.'"><i class="mdi mdi-pencil font-size-18"></i></a>';?></td>
									</tr>
									<?php }} ?>
								</tbody>
		 					</table>
