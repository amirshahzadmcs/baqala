			...
			<div class="col-sm-6">
				<div class="page-title">
					...
					<ol class="breadcrumb m-0">
						...
						<li class="breadcrumb-item active">Cost Center Transactions</li>
					</ol>
				</div>
			</div>
		</div>
        ...
        <div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4 class="header-title mb-0">Cost Center Transactions</h4>
					</div>
					<div class="card-body">
                    <form class="needs-validation" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="validationCustom03" class="form-label">Secondary Cost Center:</label>
                                    <select class="select2 form-control select2-multiple"
                                    multiple="multiple" data-placeholder="Nothing Select">
                                        <option>All</option>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3 ">
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/accounting/costcenters/costcentertransactions" class="btn btn-success mt-4 btn-md ms-2">Show Report</a>
