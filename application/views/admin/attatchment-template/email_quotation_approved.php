...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Quotation Approved | Baqala Station</title>
        <style type="text/css">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">your quotation has been approved, please login your account and check.</p>
                                <p style="line-height: 30px">Please find the attached quotation #<?php echo $result['order']['invoice_prefix'] .'-'. $result['order']['quotation_no'];?> for your required items</p>
                            </td>
                        </tr>
