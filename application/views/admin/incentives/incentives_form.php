		...
		<div class="row align-items-center">
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					...
					<button form="incentiveForm" id="submitBtn" type="submit" class="btn btn-sm btn-custom-success pull-right ms-2" title="Save"><i class="fa fa-save"></i> Save</button>
				</div>
...
<div class="container-fluid">
	<div class="page-content-wrapper">
		<?php echo form_open("admin/incentives/submit", array("id" => "incentiveForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="row size-inner-section px-2 py-4">
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="text" class="form-control" id="incentive_name" name="incentive_name" maxlength="150" required />
							</div>
							<div class="col-md-4 col-sm-12 mb-2 form-group">
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="text" class="form-control" id="target" name="target" onKeyPress="return numerics(event);" maxlength="10" required />
							</div>
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								<label for="deduction">Deduction (If delivery is less than target) <span class="text-danger">*</span></label>
								<div class="input-group">
									<input type="text" class="form-control input-mask text-left" data-inputmask="'alias': 'numeric', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" autocomplete="off" aria-label="Deduction" name="deduction" id="deduction" aria-describedby="basic-addon2" required>
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<input type="text" class="form-control input-mask text-left" data-inputmask="'alias': 'numeric', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" autocomplete="off" id="daily_bonus" name="daily_bonus" required />
							</div>
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								<label for="monthly_bonus">Monthly Bonus (If delivery is 700+) <span class="text-danger">*</span></label>
								<input type="text" class="form-control input-mask text-left" data-inputmask="'alias': 'numeric', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" autocomplete="off" id="monthly_bonus" name="monthly_bonus" required />
							</div>
							...
							<div class="col-md-4 col-sm-12 mb-2 form-group">
								...
								<select class="form-select" name="status" id="incentive_status" required>
...
<script>
    $(document).ready(function() {
        $("#incentiveForm").submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url('admin/incentives/submit') ?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
