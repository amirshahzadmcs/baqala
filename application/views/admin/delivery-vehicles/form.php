								...
								<div class="tab-pane active" id="profileTab" role="tabpanel">
									...
									<div class="row size-inner-section p-2">
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="name">Rider Name (English) <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="arabic_name">Rider Name (Arabic) <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 mb-3 form-group">
											...
											<input type="email" class="form-control" id="email" name="email" value="<?= $email; ?>" onBlur="checkDuplicateEmail()" required maxlength="150" />
											<small class="hint res-email"></small>
										</div>
										
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="mobile">Mobile Number <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="dob">Date of Birth <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="marital_status">Marital Status<span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="nationality">Nationality <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="passport">Passport Number <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="passport_expiry">Passport Expiry Date <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="iqama_no">Iqama No <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="iqama_exp">Iqama Expiry Date <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="dl_no">Driving License No <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											<label for="dl_expiry">Driving License Expiry <span class="text-danger text-danger">*</span></label>
										...
										<div class="col-md-4 col-sm-12 mb-3 form-group">
											...
											<select name="rider_type" class="form-control select2" required>
												...
												<option value="1" <?php echo ($rider_type == '1') ? "selected":"";?>>3PL (Rider_Captain)</option>
												<option value="2" <?php echo ($rider_type == '2') ? "selected":"";?>>Freelancer (Rider)</option>
											</select>
										...
										<div class="col-md-12 col-sm-12 mb-3 form-group">
											<button class="btn btn-success btn-md float-end" id="basicInfoBtn" type="submit">Update</button>
										</div>
									</div>
									<?= form_close();?>
								...
								<div class="tab-pane" id="vehicleTab" role="tabpanel">
									...
									<?php echo form_open("admin/deliveryvehicle/save_vehicle_info", array("id"=>"vehicle-form", "enctype"=>"multipart/form-data", "class"=>"form-label-left", "data-parsley-validate"=> "")); ?>
										...
										<div class="row size-inner-section p-2">
											...
											<!---- Third Party ---->
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="service_type">Service Type<span class="text-danger text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												...
												<input type="date" class="form-control" id="vehicle_expiry" name="vehicle_expiry" min="<?php echo date("Y-m-d"); ?>" value="<?= $vehicle_expiry; ?>" />
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												...
												<select style="height:410px;" name="van_make" id="van_make" class="form-control select2">
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												...
												<select style="height:410px;" name="van_model" id="van_model" class="form-control select2">
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												...
												<select style="height:410px;" name="van_color" id="van_color" class="form-control select2">
									...
									<?php echo form_open("admin/deliveryvehicle/save_bank_info", array("id"=>"bank-form", "enctype"=>"multipart/form-data", "class"=>"form-label-left", "data-parsley-validate"=> "")); ?>
										...
										<div class="row size-inner-section p-2">
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group d-none" id="iban_cont">
												<label for="iban">IBAN No <span class="text-danger text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group d-none" id="stcpay_cont">
												<label for="stc_pay_no">STC Pay No <span class="text-danger text-danger">*</span></label>
								...
								<div class="tab-pane" id="salaryTab" role="tabpanel">
									...
									<?php echo form_open("admin/deliveryvehicle/save_salary_info", array("id"=>"salary-form", "enctype"=>"multipart/form-data", "class"=>"form-label-left", "data-parsley-validate"=> "")); ?>
										...
										<div class="row size-inner-section p-2">
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="total_salary">Total Salary (in SAR)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="basic">Basic Salary (in SAR)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="food">Food Allowance (in SAR)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="daily_orders">Minimum Orders (Daily Target)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="monthly_orders">Minimum Orders (Monthly Target)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="rejection_rate">Rejection Rate of Orders (In %)<span class="text-danger">*</span></label>
											...
											<div class="col-md-4 col-sm-12 mb-3 form-group">
												<label for="daily_commision">Bonus Commision (In SAR Per Delivery) <span class="text-danger">*</span></label>
...
<script>
	...
	function checkDuplicateEmail() {
		...
		if (email_id !== "") {
			$.ajax({
				url: "<?php echo base_url();?>admin/deliveryvehicle/ajax_check_email",
				type: "GET",
				data: {
					email: email_id,
					id: id,
	...
	function checkDuplicateIqama() {
		...
		if (iqama_no !== "") {
			$.ajax({
				url: "<?php echo base_url();?>admin/deliveryvehicle/ajax_check_iqama",
				type: "GET",
				data: {
					iqama_no: iqama_no,
					id: id,
	...
	function checkDuplicateMobile() {
		...
		if (mobile !== "") {
			$.ajax({
				url: "<?php echo base_url();?>admin/deliveryvehicle/ajax_check_mobile",
				type: "GET",
				data: {
					mobile: mobile,
					id: id,
