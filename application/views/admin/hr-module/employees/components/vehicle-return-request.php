...
<div>
	<?php echo form_open("admin/master-vehicle/save-allotment", array("id" => "request_form", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
        ...
        <input type="hidden" name="allotment_status" value="return" required>
        ...
        <div class="row tab-inner-section m-2 py-2">
            <h4 class="header-title">Fill Return Detail</h4><hr>
            <div class="col-md-6 col-sm-12 mb-3 form-group">
                <label for="status_date">Date of Return<span class="text-danger">*</span></label>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        $('#requestModalFullscreenLabel').html('Vehicle Return Request');
        $('.dropify').dropify();
        $('.select2').select2({
            width: '100%'
        });
