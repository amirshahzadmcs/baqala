				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'is_referral', 'referrer_full_name', 'referrer_mobile', 'referrer_iqama_id', 'referrer_hungerstation_id', 'referrer_iban', 'rider_full_name', 'rider_mobile', 'rider_iqama_id', 'rider_iqama_expiry', 'nationality', 'email', 'dob', 'rider_city', 'rider_iban', 'saudi_status', 'iqama_file', 'license_file', 'iban_file', 'photo_file', 'created_at', 'updated_at'
                        ];
                    ?>
