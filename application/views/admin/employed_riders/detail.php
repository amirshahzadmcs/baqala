				...
				<div class="float-end d-sm-block">
					...
					<div class="btn-group ms-2">
						...
						<div class="dropdown-menu dropdown-menu-end">
							<a class="dropdown-item" href="<?php echo base_url('admin/employed-rider/print-employement-contract?id='.$emp_detail->id); ?>" target="_blank"> Employement Contract</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url('admin/employed-rider/print-vehicle-ack-receipt?id='.$emp_detail->id); ?>" target="_blank"> Vehicle Acknowledgement Receipt</a>
						</div>
					</div>
				</div>
								...
								<div class="tab-content py-3 text-muted">
									...
									<div class="tab-pane" id="bankTab" role="tabpanel">
										<div class="size-inner-section px-3 py-4">
											<div class="row">
												<div class="col-md-4 col-sm-12 mb-2 form-group">
													<label for="sim_id">Mobile No for Flex <span class="required-field">*</span></label>
													<input type="text" class="form-control" id="company_mobile" name="company_mobile" value="<?php echo $emp_detail->company_mobile;?>" readonly required />
												</div>
