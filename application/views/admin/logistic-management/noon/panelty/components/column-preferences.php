				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'penelty_date', 'emp_id', 'emp_no', 'full_name', 'vendor_name', 'date', 'city', 'default_fleet', 'da_id', 'payout_type', 'delivered', 'total_rejections', 'rejection_penalty', 'order_number', 'added_by', 'ip_address', 'created_at', 'updated_at'
                        ];
                    ?>
