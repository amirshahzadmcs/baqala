<?php $this->load->view('gate_keeper/layout/header');?>
    ...
    <div class="page-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="page-title">
                            ...
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="<?= base_url('gate-keeper');?>">Dashboard</a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="float-end d-none d-sm-block">
							<a class="btn btn-sm btn-custom-white pull-right me-1" title="Back" href="<?php echo base_url('gate-keeper');?>"><i class="fa fa-reply"></i> Back</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="page-content-wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12"><?php $this->load->view('gate_keeper/layout/profile-sidebar');?></div>
...
<!-- end page content-->
<?php $this->load->view('gate_keeper/layout/footer');?>
<script></script>
