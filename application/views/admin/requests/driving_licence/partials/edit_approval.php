...
?>
<?php echo form_open("admin/hr-module/request/driving-licence/update", array("id" => "editDlForm", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
<input type="hidden" name="dl_id" value="<?php echo $dlRequest->id; ?>" />
...
<script>
	$(document).ready(function() {
		...
		$('#editDlForm').on('submit', function (e) {
			e.preventDefault();
