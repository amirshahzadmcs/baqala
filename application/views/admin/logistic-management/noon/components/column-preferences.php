				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'emp_id', 'emp_no', 'full_name', 'local_date', 'date', 'da_id', 'payout_mot', 'fleet_zone', 'da_mtd_score', 'da_mtd_rank', 'calendar_days_mtd', 'present_days_mtd', 'da_shift', 'login_hrs', 'rejections', 'unassignments', 'delivered_orders', 'ontime', 'fm_distance', 'lm_distance', 'in_shift_login_hrs', 'delivery_rating', 'last_order_date', 'not_working_since_days', 'created_at', 'updated_at'
                        ];
                    ?>
