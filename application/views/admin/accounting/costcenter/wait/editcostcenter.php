	...
	<div class="container-fluid">
		<div class="row align-items-center">
            ...
            <div class="col-md-6 ">
                ...
                <button class="btn btn-custom-danger btn-sm pull-right me-1" title="Cancel"><i class="mdi mdi-close-thick"></i> Cancel </button>
        ...
        <div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4 class="header-title mb-0">Edit Cost Center</h4>
					</div>
					<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id="validationCustom02" placeholder="Name" required="">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="select2 form-control " data-placeholder="Nothing Select">
                                     <option value="1">Please Select Cost Center</option>
                                     <option value="1">Head Office</option>
                                     <option value="1">PLogistics - Third Party Delivery</option>
                                     <option value="1">E-Commerce</option>
                                     <option value="1">Sales & Operations</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
