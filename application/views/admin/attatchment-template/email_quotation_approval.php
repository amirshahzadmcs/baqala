...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Quotation Review | Baqala Station</title>
        <style type="text/css">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td align="left" style="padding: 36px 0px 5px;">
                                <h4 style="margin: 0; font-size: 16px; font-weight: 600; letter-spacing: 0px; line-height: 14px; color: #181818;">Hello! <?php //echo $result['order']['c_company'];?></h4>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Your requisition request no <?php echo $result['order']['invoice_prefix'] .'-'. $result['order']['quotation_no'];?> status has been updated from pending to review.</p>
                                <p style="line-height: 15px;">Kindly login, review and approve the requisition to process further.</p>
                            </td>
                        </tr>
