			...
			<tr>
				<td>
					<table class="table" width="100%" border="0" cellspacing="1" cellpadding="3" style="font-size: 10px;">
						...
						<tr><td colspan="8" style="line-height:0px;color:#aaaaaa;">*Note: Please select (Total Payable Amount) columns to view calculation of Payable Amount</td></tr>
						...
						<tr>
							...
							<td valign="middle" style="width: 12%;text-align:center;color:green;"><?php echo $totalPayableAmount; ?></td>
						</tr>
