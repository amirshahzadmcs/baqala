...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>OTP Verification | Baqala Station</title>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 15px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Thank you for choosing Baqala Station. Use the following OTP to complete your Sign Up procedures. OTP is valid for 3 minutes.</p>
