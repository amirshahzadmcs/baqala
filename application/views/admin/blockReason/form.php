		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Block Reasons Master</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/block-reasons">Block Reasons List</a></li>
			...
			<div class="col-sm-6">
					<div class="float-end d-sm-block">
						...
						<a class="btn btn-sm btn-custom pull-right" title="Back" href="<?php echo base_url(); ?>admin/block-reasons"><i class="fa fa-reply"></i> Back</a>
						<?php }?>
						&nbsp;
  		...
  		<div class="page-content-wrapper">
 			 <div class="row">
 			 	<div class="col-12">
 			 		<div class="card">
 			 			<div class="card-body">
							<?php echo form_open("admin/block-reasons/submit", array("id" => "demo-form2", "enctype" => "multipart/form-data", "class" => "form-label-left", "data-parsley-validate" => "")); ?>
