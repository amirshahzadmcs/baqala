		...
		<div class="row align-items-center">
			<div class="col-sm-6">
				<div class="page-title">
					<h4>Keeta <?= ((isset($summaryData['summary_month'])) ? date('F Y', strtotime($summaryData['summary_month'])) : ''); ?> Summary</h4>
					<ol class="breadcrumb m-0">
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="<?php echo base_url('admin/logistic-management/invoices/keeta/list'); ?>">Keeta Monthly Performance</a></li>
			...
			<div class="col-sm-6">
				<div class="float-end d-sm-block">
					<a class="btn btn-sm btn-custom-white pull-right" title="Back" href="<?php echo base_url('admin/logistic-management/invoices/keeta/list'); ?>"><i class="fa fa-reply"></i> Back</a>
											...
											<?php
												if (!empty($visibleTableColumns)) {
													foreach ($visibleTableColumns as $column) {
														$cleanedHeader = str_replace(['mkms.', 'me.'], '', $column);
...
$(document).ready(function() {
    ...
    function loadFilteredData(page = 1) {
        ...
        // AJAX Request
        $.ajax({
            url: "<?= base_url('admin/logistic-management/invoices/keeta/detail/' . $summaryData['id']) ?>",
            type: 'GET',
            ...
            success: function(response) {
				...
				if (availableColumns.length) {
					...
					availableColumns.forEach(column => {
						const cleanedHeader = column.replace('mkms.', '').replace('me.', '');
...
function getColumnForm() {
	$.ajax({
		...
		method: 'GET',
		data: { request_type: 'keeta_monthly_summary' },
		success: function(response) {
