				...
				<div class="card">
                    <?php
                        $availableTableColumns = [
                            'id', 'emp_id', 'emp_no', 'full_name', 'rider_id', 'city_name', 'contract_name', 'vehicle_name', 'batch_number', 'tga_status', 'error_codes', 'shifts', 'working_days', 'planned_working_hours', 'actual_working_hours', 'avg_working_hours', 'attendance_rate', 'break_hours', 'lost_hours', 'acceptance_rate', 'contact_rate', 'no_shows', 'no_shows_percent', 'notified_deliveries', 'completed_deliveries', 'accepted_deliveries', 'not_accepted_deliveries', 'stacked_deliveries', 'declined_deliveries', 'cancelled_deliveries', 'created_at', 'updated_at'
                        ];
                    ?>
