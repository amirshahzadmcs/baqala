                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Company Vehicle is unallotted from your ID as per below details.</p>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">Un-Allotment Date: <?= $allotment_date ? date('d-m-Y', strtotime($allotment_date)) : '';?></p>
                                <p style="line-height: 15px;">Vehicle Type: <?= $vehicle_model;?> (<?= $vehicle_make;?>)</p>
                                <p style="line-height: 15px;">Plate Number: <?= $vehicle_no;?></p>
                                <p style="line-height: 15px;">Meter Reading: <?= $meter_reading;?></p>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="left" style="padding: 10px 0px 0px; font-size: 16px; line-height: 24px;color:#000000">
                                <p style="line-height: 15px;">You are required to return the vehicle key to the logistics department upon un-allotment.</p>
                            </td>
                        </tr>
                    </table>
                </td>
